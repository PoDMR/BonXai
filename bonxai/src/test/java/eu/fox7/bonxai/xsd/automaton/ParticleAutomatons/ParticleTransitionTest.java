...
public class ParticleTransitionTest extends junit.framework.TestCase {
    ...
    public void testSetResultingParticleTestParticleA() {
        ...
        GroupRef groupRef = new GroupRef(new SymbolTableRef<eu.fox7.bonxai.common.Group>("{A}group", group));
    ...
    public void testToString() {
        ...
        String expResult = "\"(0)\"->\"(1)\"[label=\"({A}foo,{B}bar,eu.fox7.bonxai.common.AnyPattern,eu.fox7.bonxai.common.AnyPattern,epsilon)\"]\n";
