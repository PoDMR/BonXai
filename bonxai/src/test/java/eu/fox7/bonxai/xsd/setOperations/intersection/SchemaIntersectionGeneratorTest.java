...
import eu.fox7.bonxai.xsd.setOperations.intersection.SchemaIntersectionGenerator;
...
public class SchemaIntersectionGeneratorTest extends junit.framework.TestCase {
    ...
    public void testGenerateIntersection() throws Exception {
        ...
        XSDSchema schemaA = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/setOperations/intersection/xsds/testGenerateIntersectionA.xsd").getFile());
        XSDSchema schemaB = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/setOperations/intersection/xsds/testGenerateIntersectionB.xsd").getFile());
        XSDSchema schemaC = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/setOperations/intersection/xsds/testGenerateIntersectionC.xsd").getFile());
