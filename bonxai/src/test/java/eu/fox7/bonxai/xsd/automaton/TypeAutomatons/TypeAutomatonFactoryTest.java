...
import eu.fox7.bonxai.xsd.automaton.TypeAutomatons.ProductTypeAutomaton;
import eu.fox7.bonxai.xsd.automaton.TypeAutomatons.SubsetTypeAutomaton;
import eu.fox7.bonxai.xsd.automaton.TypeAutomatons.TypeAutomaton;
import eu.fox7.bonxai.xsd.automaton.TypeAutomatons.TypeAutomatonFactory;
...
public class TypeAutomatonFactoryTest extends junit.framework.TestCase {
    ...
    public void testBuildTypeAutomaton_Schema_HashMap() throws Exception {
        ...
        XSDSchema schema = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/automaton/TypeAutomatons/xsds/testBuildTypeAutomaton_Schema_HashMap.xsd").getFile());
    ...
    public void testBuildProductTypeAutomaton() throws Exception {
        XSDParser xmlSchemaParser = new XSDParser(false, false);
        XSDSchema schema1 = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/automaton/TypeAutomatons/xsds/testBuildTypeAutomaton_Schema_HashMap.xsd").getFile());
        XSDSchema schema2 = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/automaton/TypeAutomatons/xsds/testBuildSubsetTypeAutomaton.xsd").getFile());
        HashMap<AnyPattern, XSDSchema> anyPatternSchemaMap = new HashMap<AnyPattern, XSDSchema>();
    ...
    public void testBuildSubsetTypeAutomaton() throws Exception {
        XSDParser xmlSchemaParser = new XSDParser(false, false);
        XSDSchema schema = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/automaton/TypeAutomatons/xsds/testBuildSubsetTypeAutomaton.xsd").getFile());
        HashMap<AnyPattern, XSDSchema> anyPatternSchemaMap = new HashMap<AnyPattern, XSDSchema>();
        TypeAutomatonFactory instance = new TypeAutomatonFactory();
