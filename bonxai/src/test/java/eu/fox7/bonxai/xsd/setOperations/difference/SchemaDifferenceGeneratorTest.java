...
import eu.fox7.bonxai.xsd.setOperations.difference.SchemaDifferenceGenerator;
...
public class SchemaDifferenceGeneratorTest extends junit.framework.TestCase {
    ...
    public void testGenerateDifference() throws Exception {
        ...
        XSDSchema schemaA = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/setOperations/difference/xsds/testGenerateDifferenceA.xsd").getFile());
        XSDSchema schemaB = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/setOperations/difference/xsds/testGenerateDifferenceB.xsd").getFile());
