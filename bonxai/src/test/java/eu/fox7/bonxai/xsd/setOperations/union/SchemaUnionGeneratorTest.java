...
import eu.fox7.bonxai.xsd.Element.Final;
...
import eu.fox7.bonxai.xsd.setOperations.union.SchemaUnionGenerator;
...
public class SchemaUnionGeneratorTest extends junit.framework.TestCase {
    ...
    public void testGenerateUnion() throws Exception {
        ...
        XSDSchema schemaA = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/setOperations/union/xsds/testGenerateUnionA.xsd").getFile());
        XSDSchema schemaB = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/setOperations/union/xsds/testGenerateUnionB.xsd").getFile());
        XSDSchema schemaC = xmlSchemaParser.parse(this.getClass().getResource("/tests/eu/fox7/bonxai/xsd/setOperations/union/xsds/testGenerateUnionC.xsd").getFile());
