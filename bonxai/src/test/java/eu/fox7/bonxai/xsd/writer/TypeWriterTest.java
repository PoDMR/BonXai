...
import eu.fox7.bonxai.xsd.writer.DOMHelper;
import eu.fox7.bonxai.xsd.writer.FoundElements;
import eu.fox7.bonxai.xsd.writer.ParticleWriter;
import eu.fox7.bonxai.xsd.writer.TypeWriter;
...
public class TypeWriterTest extends junit.framework.TestCase
{
    ...
    public void testWriteFoundType()
    {
        ...
        element = new eu.fox7.bonxai.xsd.Element("{}myElement");
...
//        ((attribute | attributeGroup)*, anyAttribute?)) </restriction>
        ...
        eu.fox7.bonxai.xsd.Element seqEl1, seqEl2;
