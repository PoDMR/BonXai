...
import eu.fox7.bonxai.converter.relaxng2xsd.PatternElementConverter;
...
import eu.fox7.bonxai.converter.relaxng2xsd.exceptions.NoCombineMethodException;
import eu.fox7.bonxai.converter.relaxng2xsd.exceptions.TooManyDataOrValuePatternsUnderAnElementException;
...
//        System.out.println(xsd_Writer.getXSDString());
    ...
    public void testConvert_01_findRootElements_with_element() throws Exception {
        ...
        eu.fox7.bonxai.xsd.Element element = this.schema.getElements().getFirst();
    ...
    public void testConvert_02_findRootElements_with_choice() throws Exception {
        ...
        eu.fox7.bonxai.xsd.Element element = this.schema.getElements().getFirst();
        assertEquals("{}a", element.getName());
        eu.fox7.bonxai.xsd.Element element2 = this.schema.getElements().getLast();
    ...
    public void testConvert_07_convertElement_inner_nameClassAny() throws Exception {
        ...
        assertTrue(sequencePattern.getParticles().getFirst() instanceof eu.fox7.bonxai.common.AnyPattern);

        eu.fox7.bonxai.common.AnyPattern anyPattern = (eu.fox7.bonxai.common.AnyPattern) sequencePattern.getParticles().getFirst();
    ...
    public void testConvert_08_convertElement_externalNamespace() throws Exception {
        ...
        SequencePattern sequencePattern = (SequencePattern) complexContentType.getParticle();
        assertEquals(1, sequencePattern.getParticles().size());
        assertTrue(sequencePattern.getParticles().getFirst() instanceof eu.fox7.bonxai.xsd.ElementRef);

        eu.fox7.bonxai.xsd.ElementRef elementRef = (eu.fox7.bonxai.xsd.ElementRef) sequencePattern.getParticles().getFirst();
    ...
    public void testConvert_13_generateTypeForElement_attributeAndSimpleTypeContent() throws Exception {
        ...
        eu.fox7.bonxai.xsd.Attribute attribute = (eu.fox7.bonxai.xsd.Attribute) simpleContentExtension.getAttributes().getFirst();
    ...
    public void testConvert_14_generateTypeForElement_onlyAnAttribute() throws Exception {
        ...
        eu.fox7.bonxai.xsd.Attribute attribute = (eu.fox7.bonxai.xsd.Attribute) complexType.getAttributes().getFirst();
        assertEquals("{}bob", attribute.getName());
    }
    ...
    public void testConvert_15_generateTypeForElement_onlyElement() throws Exception {
        ...
        SequencePattern sequencePattern = (SequencePattern) complexContentType.getParticle();
        assertEquals(1, sequencePattern.getParticles().size());
        assertTrue(sequencePattern.getParticles().getFirst() instanceof eu.fox7.bonxai.xsd.Element);

        eu.fox7.bonxai.xsd.Element element1 = (eu.fox7.bonxai.xsd.Element) sequencePattern.getParticles().getFirst();
    ...
    public void testConvert_18_generateTypeForElement_ElementInType() throws Exception {
        ...
        eu.fox7.bonxai.xsd.Element element2 = (eu.fox7.bonxai.xsd.Element) sequencePattern.getParticles().getLast();
    ...
    public void testConvert_19_generateTypeForElement_ElementInTypeAndAttribute() throws Exception {
        ...
        eu.fox7.bonxai.xsd.Attribute attribute = (eu.fox7.bonxai.xsd.Attribute) complexContentExtension.getAttributes().getFirst();
        assertEquals("{}blub", attribute.getName());
    }
    ...
    public void testConvert_24_convertPatternToElementParticleStructure_ZeroOrMore() throws Exception {
        ...
        SequencePattern sequencePattern = (SequencePattern) complexContentType.getParticle();
        assertEquals(1, sequencePattern.getParticles().size());
        assertTrue(sequencePattern.getParticles().getFirst() instanceof eu.fox7.bonxai.common.CountingPattern);
        eu.fox7.bonxai.common.CountingPattern countingPattern = (CountingPattern) sequencePattern.getParticles().getFirst();

        assertEquals("0", countingPattern.getMin().toString());
        assertEquals(null, countingPattern.getMax());

        assertTrue(countingPattern.getParticles().getFirst() instanceof eu.fox7.bonxai.xsd.Element);

        eu.fox7.bonxai.xsd.Element element1 = (eu.fox7.bonxai.xsd.Element) countingPattern.getParticles().getFirst();
        assertEquals("{}bob", element1.getName());
    }
    ...
    public void testConvert_28_convertPatternToElementParticleStructure_Choice() throws Exception {
        ...
        assertFalse(complexContentType.getMixed());
        assertEquals(null, complexContentType.getInheritance());
        assertTrue(complexContentType.getParticle() instanceof eu.fox7.bonxai.common.ChoicePattern);
        eu.fox7.bonxai.common.ChoicePattern choicePattern = (eu.fox7.bonxai.common.ChoicePattern) complexContentType.getParticle();

        assertTrue(choicePattern.getParticles().getFirst() instanceof eu.fox7.bonxai.xsd.Element);

        eu.fox7.bonxai.xsd.Element element1 = (eu.fox7.bonxai.xsd.Element) choicePattern.getParticles().getFirst();
        assertEquals("{}bob", element1.getName());
    }
    ...
    public void testConvert_29_convertPatternToElementParticleStructure_Interleave() throws Exception {
        ...
        assertFalse(complexContentType.getMixed());
        assertEquals(null, complexContentType.getInheritance());
        assertTrue(complexContentType.getParticle() instanceof eu.fox7.bonxai.common.AllPattern);
        eu.fox7.bonxai.common.AllPattern allPattern = (eu.fox7.bonxai.common.AllPattern) complexContentType.getParticle();

        assertTrue(allPattern.getParticles().getFirst() instanceof eu.fox7.bonxai.xsd.Element);

        eu.fox7.bonxai.xsd.Element element1 = (eu.fox7.bonxai.xsd.Element) allPattern.getParticles().getFirst();
        assertEquals("{}bob", element1.getName());
    }
