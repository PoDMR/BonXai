...
import eu.fox7.bonxai.converter.relaxng2xsd.PatternSimpleTypeConverter;
...
import eu.fox7.bonxai.xsd.SimpleContentFixableRestrictionProperty;
...
public class PatternSimpleTypeConverterTest extends junit.framework.TestCase {
    ...
    private void writeToSystemOut(SimpleType simpleType) {
        eu.fox7.bonxai.xsd.Element dummyElement = new eu.fox7.bonxai.xsd.Element("{}dummy", this.schema.getTypeSymbolTable().updateOrCreateReference(simpleType.getName(), simpleType));
    ...
    public void testGenerateSimpleTypeForPattern_01() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_01.rng");
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_02() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_02.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_03() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_03.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_04() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_04.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_05() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_05.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_06() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_06.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_07() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_07.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_08() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_08.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_09() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_09.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_10() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_10.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_11() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_11.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_12() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_12.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_13() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_13.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_14() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_14.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
...
//        writeToSystemOut(result);
    ...
    public void testGenerateSimpleTypeForPattern_15() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternSimpleTypeConverterTest/simpleType_15.rng");
        PatternSimpleTypeConverter instance = new PatternSimpleTypeConverter(schema, rng, patternInformation, usedLocalNames, usedLocalNames);
