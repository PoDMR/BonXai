...
import eu.fox7.bonxai.converter.xsd2dtd.AttributeUnionBuilder;
...
public class AttributeUnionBuilderTest extends junit.framework.TestCase {
    ...
    public void testUnifyAttributes_null_type() throws Exception {
        ...
        String name = "name";
        eu.fox7.bonxai.dtd.Attribute dtdAttribute1 = new eu.fox7.bonxai.dtd.Attribute(name, attr1DefaultPresenceMode, attr1Value);
        dtdAttribute1.setEnumerationOrNotationTokens(attr1EnumerationTokens);
        dtdAttribute1.setType(attr1Type);
        eu.fox7.bonxai.dtd.Attribute dtdAttribute2 = new eu.fox7.bonxai.dtd.Attribute(name, attr2DefaultPresenceMode, attr2Value);
