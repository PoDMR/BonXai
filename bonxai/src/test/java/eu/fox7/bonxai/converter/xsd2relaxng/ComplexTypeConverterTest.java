...
public class ComplexTypeConverterTest extends junit.framework.TestCase {
    ...
    public void testConvert_ComplexType_mixed() {
        ...
        assertTrue(result instanceof eu.fox7.bonxai.relaxng.Group);
        eu.fox7.bonxai.relaxng.Group group = (eu.fox7.bonxai.relaxng.Group) result;
        assertEquals(1, group.getPatterns().size());
        assertTrue(group.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Mixed);
        Mixed mixed = (Mixed) group.getPatterns().getFirst();
        assertEquals(1, mixed.getPatterns().size());
        assertTrue(mixed.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Attribute);

        eu.fox7.bonxai.relaxng.Attribute attributePattern = (eu.fox7.bonxai.relaxng.Attribute) mixed.getPatterns().getFirst();
    ...
    public void testConvert_ComplexType_abstract() {
        ...
        assertTrue(group.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.NotAllowed);
        assertTrue(group.getPatterns().getLast() instanceof eu.fox7.bonxai.relaxng.Attribute);

        eu.fox7.bonxai.relaxng.Attribute attributePattern = (eu.fox7.bonxai.relaxng.Attribute) group.getPatterns().getLast();
    ...
    public void testConvert_ComplexType_complexContent_no_inheritance_anyPattern() {
        ...
        assertTrue(result instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element = (eu.fox7.bonxai.relaxng.Element) result;
    ...
    public void testConvert_ComplexType_complexContent_no_inheritance_element_choice_sequence() throws FileNotFoundException, FileNotFoundException {
        ...
        eu.fox7.bonxai.relaxng.Element element2 = (eu.fox7.bonxai.relaxng.Element) result;
    ...
    public void testConvert_ComplexType_complexContent_no_inheritance_countingPattern_star_element() {
        ...
        eu.fox7.bonxai.relaxng.ZeroOrMore zeroOrMore = (ZeroOrMore) result;
        assertEquals(1, zeroOrMore.getPatterns().size());
        assertTrue(zeroOrMore.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element2 = (eu.fox7.bonxai.relaxng.Element) zeroOrMore.getPatterns().getFirst();
    ...
    public void testConvert_ComplexType_complexContent_no_inheritance_countingPattern_questionmark_element() {
        ...
        eu.fox7.bonxai.relaxng.Optional optional = (eu.fox7.bonxai.relaxng.Optional) result;
        assertEquals(1, optional.getPatterns().size());
        assertTrue(optional.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element2 = (eu.fox7.bonxai.relaxng.Element) optional.getPatterns().getFirst();
    ...
    public void testConvert_ComplexType_complexContent_no_inheritance_countingPattern_plus_element() {
        ...
        assertTrue(result instanceof eu.fox7.bonxai.relaxng.OneOrMore);
        eu.fox7.bonxai.relaxng.OneOrMore oneOrMore = (eu.fox7.bonxai.relaxng.OneOrMore) result;
        assertEquals(1, oneOrMore.getPatterns().size());
        assertTrue(oneOrMore.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element2 = (eu.fox7.bonxai.relaxng.Element) oneOrMore.getPatterns().getFirst();
    ...
    public void testConvert_ComplexType_complexContent_no_inheritance_countingPattern_other_element() {
        ...
        eu.fox7.bonxai.relaxng.Group group = (eu.fox7.bonxai.relaxng.Group) result;
        assertEquals(2, group.getPatterns().size());
        assertTrue(group.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);
        eu.fox7.bonxai.relaxng.Element element1 = (eu.fox7.bonxai.relaxng.Element) group.getPatterns().getFirst();

        assertEquals("myElement", element1.getNameAttribute());
        assertEquals(null, element1.getAttributeNamespace());

        assertTrue(group.getPatterns().getLast() instanceof eu.fox7.bonxai.relaxng.Optional);
        eu.fox7.bonxai.relaxng.Optional optional = (eu.fox7.bonxai.relaxng.Optional) group.getPatterns().getLast();
        assertEquals(1, optional.getPatterns().size());
        assertTrue(optional.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);
    ...
    public void testConvert_ComplexType_complexContent_no_inheritance_all_element() {
        ...
        assertTrue(result instanceof eu.fox7.bonxai.relaxng.Interleave);
        eu.fox7.bonxai.relaxng.Interleave interleave = (eu.fox7.bonxai.relaxng.Interleave) result;
        assertEquals(2, interleave.getPatterns().size());
        assertTrue(interleave.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element3 = (eu.fox7.bonxai.relaxng.Element) interleave.getPatterns().getFirst();

        assertEquals("myElement", element3.getNameAttribute());
        assertEquals(null, element3.getAttributeNamespace());

        assertTrue(interleave.getPatterns().getLast() instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element4 = (eu.fox7.bonxai.relaxng.Element) interleave.getPatterns().getLast();
    ...
    public void testConvert_ComplexType_complexContent_no_inheritance_elementRef() {
        ...
        assertTrue(interleave.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Ref);

        eu.fox7.bonxai.relaxng.Ref ref = (eu.fox7.bonxai.relaxng.Ref) interleave.getPatterns().getFirst();
        assertEquals(1, ref.getDefineList().size());
        Define define = ref.getDefineList().getFirst();
        assertEquals(1, define.getPatterns().size());

        assertTrue(define.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element3 = (eu.fox7.bonxai.relaxng.Element) define.getPatterns().getFirst();
    ...
    public void testConvert_ComplexType_complexContent_no_inheritance_group_groupRef() {
        ...
        eu.fox7.bonxai.xsd.Group xsdGroup = new Group("{}group", allPattern);
        ...
        eu.fox7.bonxai.relaxng.Ref ref = (eu.fox7.bonxai.relaxng.Ref) result;
        assertEquals(1, ref.getDefineList().size());
        Define define = ref.getDefineList().getFirst();
        assertEquals(1, define.getPatterns().size());

        assertTrue(define.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Group);

        eu.fox7.bonxai.relaxng.Group groupPattern = (eu.fox7.bonxai.relaxng.Group) define.getPatterns().getFirst();
        assertEquals(1, groupPattern.getPatterns().size());

        assertTrue(groupPattern.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Interleave);

        eu.fox7.bonxai.relaxng.Interleave interleave = (eu.fox7.bonxai.relaxng.Interleave) groupPattern.getPatterns().getFirst();
        assertEquals(2, interleave.getPatterns().size());

        assertTrue(interleave.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Ref);

        eu.fox7.bonxai.relaxng.Ref ref2 = (eu.fox7.bonxai.relaxng.Ref) interleave.getPatterns().getFirst();
        assertEquals(1, ref2.getDefineList().size());
        Define define2 = ref2.getDefineList().getFirst();
        assertEquals(1, define2.getPatterns().size());

        assertTrue(define2.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element3 = (eu.fox7.bonxai.relaxng.Element) define2.getPatterns().getFirst();
    ...
    public void testHandleSubstitutions() throws Exception {
        ...
        assertTrue(choice.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Ref);
        eu.fox7.bonxai.relaxng.Ref ref1 = (eu.fox7.bonxai.relaxng.Ref) choice.getPatterns().getFirst();
        assertEquals("AAA", ref1.getRefName());

        assertTrue(choice.getPatterns().getLast() instanceof eu.fox7.bonxai.relaxng.Ref);
        eu.fox7.bonxai.relaxng.Ref ref = (eu.fox7.bonxai.relaxng.Ref) choice.getPatterns().getLast();
        ...
        assertTrue(define.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Ref);

        eu.fox7.bonxai.relaxng.Ref ref2 = (eu.fox7.bonxai.relaxng.Ref) define.getPatterns().getFirst();
    ...
    public void testConvert_ComplexType_simpleContentExtension() throws Exception {
        ...
        assertTrue(define2.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Data);

        eu.fox7.bonxai.relaxng.Data data = (eu.fox7.bonxai.relaxng.Data) define2.getPatterns().getFirst();
    ...
    public void testConvert_ComplexType_simpleContentRestriction_content_and_baseComplexType_mixed() throws Exception {
        ...
        eu.fox7.bonxai.relaxng.Group groupPattern = (eu.fox7.bonxai.relaxng.Group) result;

        assertEquals(2, groupPattern.getPatterns().size());
        assertTrue(groupPattern.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Group);

        eu.fox7.bonxai.relaxng.Group groupPattern2 = (eu.fox7.bonxai.relaxng.Group) groupPattern.getPatterns().getFirst();

        assertEquals(1, groupPattern2.getPatterns().size());
        assertTrue(groupPattern2.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Mixed);


        eu.fox7.bonxai.relaxng.Mixed mixed = (eu.fox7.bonxai.relaxng.Mixed) groupPattern2.getPatterns().getFirst();
        assertEquals(1, mixed.getPatterns().size());
        assertTrue(mixed.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Optional);
        eu.fox7.bonxai.relaxng.Optional optional = (eu.fox7.bonxai.relaxng.Optional) mixed.getPatterns().getFirst();
        assertEquals(1, optional.getPatterns().size());
        assertTrue(optional.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Attribute);
        eu.fox7.bonxai.relaxng.Attribute attribute1 = (eu.fox7.bonxai.relaxng.Attribute) optional.getPatterns().getFirst();

        assertEquals("attr1", attribute1.getNameAttribute());

        assertTrue(groupPattern.getPatterns().getLast() instanceof eu.fox7.bonxai.relaxng.Data);
        eu.fox7.bonxai.relaxng.Data data = (eu.fox7.bonxai.relaxng.Data) groupPattern.getPatterns().getLast();
    ...
    public void testConvert_ComplexType_complexContentExtension() throws Exception {
        ...
        assertEquals(2, groupPattern.getPatterns().size());
        assertTrue(groupPattern.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Ref);

        eu.fox7.bonxai.relaxng.Ref ref = (eu.fox7.bonxai.relaxng.Ref) groupPattern.getPatterns().getFirst();
        ...
        eu.fox7.bonxai.relaxng.Group groupPattern2 = (eu.fox7.bonxai.relaxng.Group) define.getPatterns().getFirst();

        assertEquals(2, groupPattern2.getPatterns().size());
        assertTrue(groupPattern2.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);
        eu.fox7.bonxai.relaxng.Element element = (eu.fox7.bonxai.relaxng.Element) groupPattern2.getPatterns().getFirst();
        assertEquals("test", element.getNameAttribute());
        assertEquals("http://www.w3.org/2001/ds", element.getAttributeNamespace());

        assertTrue(groupPattern2.getPatterns().getLast() instanceof eu.fox7.bonxai.relaxng.Optional);

        eu.fox7.bonxai.relaxng.Optional optional = (eu.fox7.bonxai.relaxng.Optional) groupPattern2.getPatterns().getLast();
        assertEquals(1, optional.getPatterns().size());
        assertTrue(optional.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Attribute);
        eu.fox7.bonxai.relaxng.Attribute attr2 = (eu.fox7.bonxai.relaxng.Attribute) optional.getPatterns().getFirst();

        assertEquals("attr2", attr2.getNameAttribute());
        assertEquals("http://www.w3.org/2001/ds", attr2.getAttributeNamespace());


        assertTrue(groupPattern.getPatterns().getLast() instanceof eu.fox7.bonxai.relaxng.Optional);

        eu.fox7.bonxai.relaxng.Optional optional2 = (eu.fox7.bonxai.relaxng.Optional) groupPattern.getPatterns().getLast();
        assertEquals(1, optional2.getPatterns().size());
        assertTrue(optional2.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Attribute);
        eu.fox7.bonxai.relaxng.Attribute attr3 = (eu.fox7.bonxai.relaxng.Attribute) optional2.getPatterns().getFirst();
    ...
    public void testConvert_ComplexType_complexContentRestriction() throws Exception {
        ...
        assertTrue(groupPattern.getPatterns().get(0) instanceof eu.fox7.bonxai.relaxng.Optional);

        eu.fox7.bonxai.relaxng.Optional optional = (eu.fox7.bonxai.relaxng.Optional) groupPattern.getPatterns().get(0);
        assertEquals(1, optional.getPatterns().size());
        assertTrue(optional.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Attribute);
        eu.fox7.bonxai.relaxng.Attribute attr1 = (eu.fox7.bonxai.relaxng.Attribute) optional.getPatterns().getFirst();

        assertEquals("attr1", attr1.getNameAttribute());
        assertEquals("http://www.w3.org/2001/ds", attr1.getAttributeNamespace());


        assertTrue(groupPattern.getPatterns().get(1) instanceof eu.fox7.bonxai.relaxng.Optional);

        eu.fox7.bonxai.relaxng.Optional optional2 = (eu.fox7.bonxai.relaxng.Optional) groupPattern.getPatterns().get(1);
        assertEquals(1, optional2.getPatterns().size());
        assertTrue(optional2.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Attribute);
        eu.fox7.bonxai.relaxng.Attribute attr2 = (eu.fox7.bonxai.relaxng.Attribute) optional2.getPatterns().getFirst();

        assertEquals("attr2", attr2.getNameAttribute());
        assertEquals("http://www.w3.org/2001/ds", attr2.getAttributeNamespace());


        assertTrue(groupPattern.getPatterns().get(2) instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element = (eu.fox7.bonxai.relaxng.Element) groupPattern.getPatterns().get(2);
