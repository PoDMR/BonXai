...
public class ElementUnionBuilderTest extends junit.framework.TestCase {
    ...
    public void testUnifyElements_EMPTY_mixed_content() throws Exception {
        ...
        choicePattern.addParticle(new eu.fox7.bonxai.dtd.ElementRef(dtd.getElementSymbolTable().updateOrCreateReference("element", new Element("element"))));
        ...
        assertTrue(choicePattern1.getParticles().getFirst() instanceof eu.fox7.bonxai.dtd.ElementRef);

        Element element3 = ((eu.fox7.bonxai.dtd.ElementRef) choicePattern1.getParticles().getFirst()).getElement();
    ...
    public void testUnifyElements_EMPTY_counting_questionMark() throws Exception {
        ...
        countingPattern.addParticle(new eu.fox7.bonxai.dtd.ElementRef(dtd.getElementSymbolTable().updateOrCreateReference("element", new Element("element"))));
        Particle dtdElement2particle = countingPattern;
        ...
        assertTrue(countingPattern1.getParticles().getFirst() instanceof eu.fox7.bonxai.dtd.ElementRef);

        Element element3 = ((eu.fox7.bonxai.dtd.ElementRef) countingPattern1.getParticles().getFirst()).getElement();
        assertEquals("element", element3.getName());
    }
    ...
    public void testUnifyElements_EMPTY_complex_content() throws Exception {
        ...
        sequencePattern.addParticle(new eu.fox7.bonxai.dtd.ElementRef(dtd.getElementSymbolTable().updateOrCreateReference("element", new Element("element"))));
        sequencePattern.addParticle(new eu.fox7.bonxai.dtd.ElementRef(dtd.getElementSymbolTable().updateOrCreateReference("element2", new Element("element2"))));
        ...
        assertTrue(sequencePattern1.getParticles().getFirst() instanceof eu.fox7.bonxai.dtd.ElementRef);

        Element element3 = ((eu.fox7.bonxai.dtd.ElementRef) sequencePattern1.getParticles().getFirst()).getElement();
        assertEquals("element", element3.getName());

        assertTrue(sequencePattern1.getParticles().getLast() instanceof eu.fox7.bonxai.dtd.ElementRef);

        Element element4 = ((eu.fox7.bonxai.dtd.ElementRef) sequencePattern1.getParticles().getLast()).getElement();
    ...
    public void testUnifyElements_mixed_complex_content() throws Exception {
        ...
        assertTrue(choicePattern1.getParticles().getLast() instanceof eu.fox7.bonxai.dtd.ElementRef);

        Element element4 = ((eu.fox7.bonxai.dtd.ElementRef) choicePattern1.getParticles().getLast()).getElement();
        assertEquals("element2", element4.getName());
    }
    ...
    public void testUnifyElements_mixed_content_mixed_content() throws Exception {
        ...
        CountingPattern countingPattern = new CountingPattern(0, null);
        ChoicePattern choicePattern = new ChoicePattern();
        choicePattern.addParticle(new eu.fox7.bonxai.dtd.ElementRef(dtd.getElementSymbolTable().updateOrCreateReference("element1", new Element("element1"))));
        countingPattern.addParticle(choicePattern);
        ...
        choicePattern2.addParticle(new eu.fox7.bonxai.dtd.ElementRef(dtd.getElementSymbolTable().updateOrCreateReference("element2", new Element("element2"))));
    ...
    public void testUnifyElements_mixed_content_counting_questionMark() throws Exception {
        ...
        countingPattern2.addParticle(new eu.fox7.bonxai.dtd.ElementRef(dtd.getElementSymbolTable().updateOrCreateReference("element2", new Element("element2"))));
        Particle dtdElement2particle = countingPattern2;
    ...
    public void testUnifyElements_mixed_content_complex_content() throws Exception {
        ...
        SequencePattern sequencePattern = new SequencePattern();
        sequencePattern.addParticle(new eu.fox7.bonxai.dtd.ElementRef(dtd.getElementSymbolTable().updateOrCreateReference("element1", new Element("element1"))));
        sequencePattern.addParticle(new eu.fox7.bonxai.dtd.ElementRef(dtd.getElementSymbolTable().updateOrCreateReference("element2", new Element("element2"))));
        Particle dtdElement2particle = sequencePattern;
    ...
    public void testUnifyElements_complex_content_complex_content() throws Exception {
        ...
        assertTrue(choicePattern2.getParticles().getFirst() instanceof eu.fox7.bonxai.dtd.ElementRef);

        Element element5 = ((eu.fox7.bonxai.dtd.ElementRef) choicePattern2.getParticles().getFirst()).getElement();
    ...
    public void testUnifyElements_complex_content_complex_content_with_one_choice() throws Exception {
        ...
        Element element5 = ((eu.fox7.bonxai.dtd.ElementRef) choicePattern1.getParticles().getFirst()).getElement();
