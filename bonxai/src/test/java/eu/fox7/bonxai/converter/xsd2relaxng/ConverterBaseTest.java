...
public class ConverterBaseTest extends junit.framework.TestCase {
    ...
    public void testGetXsdGroupDefineRefMap() {
        ...
        HashMap<eu.fox7.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>> myMap = new HashMap<eu.fox7.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>>();

        instance.setXsdGroupDefineRefMap(myMap);

        HashMap<eu.fox7.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>> result = instance.getXsdGroupDefineRefMap();
        assertEquals(myMap, result);
    }
    ...
    public void testRegisterDummyInDefineRefMap_Group() {
        ...
        Grammar grammar = new Grammar();
        rng.setRootPattern(grammar);
        eu.fox7.bonxai.xsd.Group group = new eu.fox7.bonxai.xsd.Group("{}test", null);
        String expResult = "test";
    ...
    public void testGenerateAnyTypePattern() {
        ...
        assertTrue(choice.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);
        eu.fox7.bonxai.relaxng.Element element = (eu.fox7.bonxai.relaxng.Element) choice.getPatterns().getFirst();
        ...
        assertTrue(element.getPatterns().get(0) instanceof eu.fox7.bonxai.relaxng.Ref);
        ...
        assertTrue(choice.getPatterns().get(1) instanceof eu.fox7.bonxai.relaxng.Text);

        assertTrue(choice.getPatterns().get(2) instanceof eu.fox7.bonxai.relaxng.Attribute);
        eu.fox7.bonxai.relaxng.Attribute attribute = (eu.fox7.bonxai.relaxng.Attribute) choice.getPatterns().get(2);
    ...
    public void testGenerateAnyAttributePattern_without_Namespace() {
        ...
        eu.fox7.bonxai.relaxng.Attribute attribute = (eu.fox7.bonxai.relaxng.Attribute) zeroOrMore.getPatterns().getFirst();
    ...
    public void testCollectAttributeNamesWithIDTypeRecursively() {
        ...
        eu.fox7.bonxai.xsd.Attribute attribute = new Attribute("{}myAttribute", xmlSchema.getTypeSymbolTable().updateOrCreateReference("{" + XSD2RelaxNGConverter.XMLSCHEMA_NAMESPACE + "}ID", simpleType));
        ...
        eu.fox7.bonxai.xsd.Attribute attribute2 = new Attribute("{}myAttribute2", importedSchema2.getSchema().getTypeSymbolTable().updateOrCreateReference("{" + XSD2RelaxNGConverter.XMLSCHEMA_NAMESPACE + "}IDREF", simpleType2));
