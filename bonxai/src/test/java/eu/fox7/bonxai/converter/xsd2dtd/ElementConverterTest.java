...
public class ElementConverterTest extends junit.framework.TestCase {
    ...
    public void testConvert() throws Exception {
        ...
        eu.fox7.bonxai.xsd.Element element = new eu.fox7.bonxai.xsd.Element("{}elementName");
    ...
    public void testConvertElement_Element() {
        ...
        eu.fox7.bonxai.xsd.Element element = new eu.fox7.bonxai.xsd.Element("{" + XSD2DTDConverter.XMLSCHEMA_NAMESPACE + "}name");
    ...
    public void testConvertElement_complexType_mixed_with_content() {
        ...
        sequencePattern.addParticle(new eu.fox7.bonxai.xsd.ElementRef(schema.getElementSymbolTable().updateOrCreateReference("{}element1", new eu.fox7.bonxai.xsd.Element("{}element1"))));
        sequencePattern.addParticle(new eu.fox7.bonxai.xsd.ElementRef(schema.getElementSymbolTable().updateOrCreateReference("{}element2", new eu.fox7.bonxai.xsd.Element("{}element2"))));
        sequencePattern.addParticle(new eu.fox7.bonxai.xsd.ElementRef(schema.getElementSymbolTable().updateOrCreateReference("{}element3", new eu.fox7.bonxai.xsd.Element("{}element1"))));
    ...
    public void testConvertElement_complexType_with_choice() {
        ...
        choicePattern.addParticle(new eu.fox7.bonxai.xsd.ElementRef(schema.getElementSymbolTable().updateOrCreateReference("{}element1", new eu.fox7.bonxai.xsd.Element("{}element1"))));
        choicePattern.addParticle(new eu.fox7.bonxai.xsd.ElementRef(schema.getElementSymbolTable().updateOrCreateReference("{}element2", new eu.fox7.bonxai.xsd.Element("{}element2"))));
        choicePattern.addParticle(new eu.fox7.bonxai.xsd.ElementRef(schema.getElementSymbolTable().updateOrCreateReference("{}element3", new eu.fox7.bonxai.xsd.Element("{}element1"))));
        ComplexContentType complexContentType = new ComplexContentType();
    ...
    public void testConvertElement_complexType_with_allPattern_1() throws Exception {
        ...
        allPattern.addParticle(new eu.fox7.bonxai.xsd.ElementRef(schema.getElementSymbolTable().updateOrCreateReference("{}element1", new eu.fox7.bonxai.xsd.Element("{}element1"))));
        allPattern.addParticle(new eu.fox7.bonxai.xsd.ElementRef(schema.getElementSymbolTable().updateOrCreateReference("{}element2", new eu.fox7.bonxai.xsd.Element("{}element2"))));
        ComplexContentType complexContentType = new ComplexContentType();
    ...
    public void testConvertElement_complexType_with_countingPattern_1() throws Exception {
        ...
        countingPattern1.addParticle(new eu.fox7.bonxai.xsd.ElementRef(schema.getElementSymbolTable().updateOrCreateReference("{}element1", new eu.fox7.bonxai.xsd.Element("{}element1"))));
        ComplexContentType complexContentType = new ComplexContentType();
