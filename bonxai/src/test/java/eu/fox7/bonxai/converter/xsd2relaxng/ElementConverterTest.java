...
public class ElementConverterTest extends junit.framework.TestCase {
    ...
    public void testConvertElement() {
        ...
        ElementConverter instance = new ElementConverter(
                ...
                new LinkedHashMap<eu.fox7.bonxai.xsd.Element, LinkedHashSet<eu.fox7.bonxai.xsd.Element>>(),
        ...
        eu.fox7.bonxai.relaxng.Element elementPattern = (eu.fox7.bonxai.relaxng.Element) result;
    ...
    public void testConvertElement_ref() {
        ...
        eu.fox7.bonxai.relaxng.Element elementPattern = (eu.fox7.bonxai.relaxng.Element) define.getPatterns().getFirst();
        assertEquals("name", elementPattern.getNameAttribute());
        assertEquals("namespace", elementPattern.getAttributeNamespace());
        assertEquals(1, elementPattern.getPatterns().size());
    ...
    public void testHandleSubstitutions() throws Exception {
        ...
        assertTrue(define1.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Element);

        eu.fox7.bonxai.relaxng.Element element2 = (eu.fox7.bonxai.relaxng.Element) define1.getPatterns().getFirst();
