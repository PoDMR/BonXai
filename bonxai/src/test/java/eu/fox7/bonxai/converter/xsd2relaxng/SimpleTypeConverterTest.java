...
public class SimpleTypeConverterTest extends junit.framework.TestCase {
    ...
    public void testConvert_SimpleType_List() {
        ...
        assertTrue(result instanceof eu.fox7.bonxai.relaxng.List);

        eu.fox7.bonxai.relaxng.List list = (eu.fox7.bonxai.relaxng.List) result;
    ...
    public void testConvert_SimpleType_Union() {
        ...
        assertTrue(result instanceof eu.fox7.bonxai.relaxng.Data);
    ...
    public void testConvert_SimpleType_Union2() {
        ...
        assertTrue(result instanceof eu.fox7.bonxai.relaxng.Choice);
        eu.fox7.bonxai.relaxng.Choice choice = (Choice) result;

        assertEquals(2, choice.getPatterns().size());
        assertTrue(choice.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.Data);
        assertTrue(choice.getPatterns().getLast() instanceof eu.fox7.bonxai.relaxng.Data);
    ...
    public void testConvertSimpleTypeInheritance_attributes() {
        ...
        eu.fox7.bonxai.xsd.Attribute attribute = new eu.fox7.bonxai.xsd.Attribute("{}attributeName", xmlSchema.getTypeSymbolTable().getReference("{" + XSD2RelaxNGConverter.XMLSCHEMA_NAMESPACE + "}string"), null, null, AttributeUse.Required, Boolean.FALSE, XSDSchema.Qualification.qualified, null);
        ...
        assertTrue(group.getPatterns().get(1) instanceof eu.fox7.bonxai.relaxng.Attribute);
        eu.fox7.bonxai.relaxng.Attribute attributePattern = (eu.fox7.bonxai.relaxng.Attribute) group.getPatterns().get(1);
    ...
    public void testHandleSubstitutions() throws Exception {
        ...
        assertTrue(choice.getPatterns().getFirst() instanceof eu.fox7.bonxai.relaxng.List);

        eu.fox7.bonxai.relaxng.List list = (eu.fox7.bonxai.relaxng.List) choice.getPatterns().getFirst();
        ...
        eu.fox7.bonxai.relaxng.Ref ref = (Ref) choice.getPatterns().getLast();
        ...
        eu.fox7.bonxai.relaxng.Ref ref2 = (Ref) define.getPatterns().getFirst();
