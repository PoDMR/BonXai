...
public class ConstraintVisitorTest extends junit.framework.TestCase {
    ...
    throws SymbolAlreadyRegisteredException {
        ...
        eu.fox7.bonxai.xsd.Element element1 = new eu.fox7.bonxai.xsd.Element( "{}element_1" );
        eu.fox7.bonxai.xsd.Element element2 = new eu.fox7.bonxai.xsd.Element( "{}element_2" );
