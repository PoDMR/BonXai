...
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.content.WrongComplexContentMixedValueException;
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.inheritance.ComplexContentMultipleInheritanceException;
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.inheritance.MissingComplexContentInheritanceException;
...
public class ComplexContentProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCase() throws Exception {
         try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexContentTests/complexcontent_valid.xsd"));
    ...
    public void testWrongComplexContentMixedValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexContentTests/complexcontent_invalid_mixed.xsd"));
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexContentTests/complexcontent_empty_id.xsd"));
    ...
    public void testMissingComplexContentInheritanceException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexContentTests/complexcontent_no_inherit.xsd"));
    ...
    public void testComplexContentMultipleInheritanceExceptionWithRestriction() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexContentTests/complexcontent_multi_inherit_restr.xsd"));
    ...
    public void testComplexContentMultipleInheritanceExceptionWithExtension() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexContentTests/complexcontent_multi_inherit_ext.xsd"));
        } catch (ComplexContentMultipleInheritanceException error) {
            return;
        }
        fail("There is more than one Inheritance given, but this was not detected.");
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexContentTests/complexcontent_multi_annot.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexContentTests/complexcontent_wrong_content.xsd"));
