...
import de.tudortmund.cs.bonxai.relaxng.OneOrMore;
...
import de.tudortmund.cs.bonxai.relaxng.Interleave;
...
public class ConverterBaseTest extends junit.framework.TestCase {
    ...
    public void testGetXsdGroupDefineRefMap() {
        ...
        HashMap<de.tudortmund.cs.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>> myMap = new HashMap<de.tudortmund.cs.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>>();

        instance.setXsdGroupDefineRefMap(myMap);

        HashMap<de.tudortmund.cs.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>> result = instance.getXsdGroupDefineRefMap();
        assertEquals(myMap, result);
    }
    ...
    public void testRegisterDummyInDefineRefMap_Group() {
        ...
        Grammar grammar = new Grammar();
        rng.setRootPattern(grammar);
        de.tudortmund.cs.bonxai.xsd.Group group = new de.tudortmund.cs.bonxai.xsd.Group("{}test", null);
        String expResult = "test";
    ...
    public void testGenerateAnyTypePattern() {
        ...
        assertTrue(choice.getPatterns().getFirst() instanceof de.tudortmund.cs.bonxai.relaxng.Element);
        de.tudortmund.cs.bonxai.relaxng.Element element = (de.tudortmund.cs.bonxai.relaxng.Element) choice.getPatterns().getFirst();
        ...
        assertTrue(element.getPatterns().get(0) instanceof de.tudortmund.cs.bonxai.relaxng.Ref);
        ...
        assertTrue(choice.getPatterns().get(1) instanceof de.tudortmund.cs.bonxai.relaxng.Text);

        assertTrue(choice.getPatterns().get(2) instanceof de.tudortmund.cs.bonxai.relaxng.Attribute);
        de.tudortmund.cs.bonxai.relaxng.Attribute attribute = (de.tudortmund.cs.bonxai.relaxng.Attribute) choice.getPatterns().get(2);
    ...
    public void testGenerateAnyAttributePattern_without_Namespace() {
        ...
        de.tudortmund.cs.bonxai.relaxng.Attribute attribute = (de.tudortmund.cs.bonxai.relaxng.Attribute) zeroOrMore.getPatterns().getFirst();
    ...
    public void testCollectAttributeNamesWithIDTypeRecursively() {
        ...
        de.tudortmund.cs.bonxai.xsd.Attribute attribute = new Attribute("{}myAttribute", xmlSchema.getTypeSymbolTable().updateOrCreateReference("{" + XSD2RelaxNGConverter.XMLSCHEMA_NAMESPACE + "}ID", simpleType));
        ...
        de.tudortmund.cs.bonxai.xsd.Attribute attribute2 = new Attribute("{}myAttribute2", importedSchema2.getSchema().getTypeSymbolTable().updateOrCreateReference("{" + XSD2RelaxNGConverter.XMLSCHEMA_NAMESPACE + "}IDREF", simpleType2));
