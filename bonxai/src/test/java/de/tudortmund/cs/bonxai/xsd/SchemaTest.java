...
public class SchemaTest extends junit.framework.TestCase {
    ...
    public void testAddGroup() {
        SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Group> symref;
        String key1, key2;
        Group g1, g2;
        String name1, name2;
        ParticleContainer pc1, pc2;

        LinkedList<de.tudortmund.cs.bonxai.xsd.Group> list;
        int tmpSize;
        ...
        symref = new SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Group>(key1, g1);
        schema.addGroup(symref);

        pc2 = new ChoicePattern();
        g2 = new Group(name2, pc2);
        symref = new SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Group>(key2, g2);
        schema.addGroup(symref);
