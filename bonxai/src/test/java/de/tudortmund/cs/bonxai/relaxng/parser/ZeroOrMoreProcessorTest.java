...
public class ZeroOrMoreProcessorTest extends junit.framework.TestCase {
    ...
    public void testValidCase() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/zeroOrMoreTests/zeroOrMore_valid.rng"));
    ...
    public void testInValidCaseWithUnsupportedContentException() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/zeroOrMoreTests/zeroOrMore_invalid_content.rng"));
    ...
    public void testInValidCaseWithEmptyPatternException() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/zeroOrMoreTests/zeroOrMore_empty_content.rng"));
