...
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.type.MultipleTypesException;
...
public class AttributeProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCaseWithAttribute() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_valid_attribute.xsd"));
    ...
    public void testValidCaseWithAttributeRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_valid_attributeRef.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
        ComplexType complexType = (ComplexType) schema.getTypeSymbolTable().getReference("{http://www.w3.org/2001/XMLSchema}complex").getReference();
    ...
    public void testInvalidNCNameExceptionWithName() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_invalid_qName_name.xsd"));
    ...
    public void testInvalidQNameExceptionWithType() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_invalid_qName_type.xsd"));
    ...
    public void testInvalidQNameExceptionWithRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_invalid_qName_ref.xsd"));
        } catch (InvalidQNameException error) {
            return;
        }
    ...
    public void testEmptyIdExceptionWithAttribute() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_empty_id.xsd"));
    ...
    public void testInvalidFormValueLocationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_invalid_form_value_location.xsd"));
    ...
    public void testInvalidFormValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_invalid_form_value.xsd"));
    ...
    public void testInvalidUseValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_invalid_use_value.xsd"));
    ...
    public void testExclusiveAttributesExceptionWithFixedAndDefault() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_exclusive_attributes_fixed_default.xsd"));
    ...
    public void testMissingNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_missing_name.xsd"));
    ...
    public void testExclusiveAttributesExceptionWithNameAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_exclusive_attributes_name_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testExclusiveAttributesExceptionWithTypeAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_exclusive_attributes_type_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testExclusiveAttributesExceptionWithFormAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_exclusive_attributes_form_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testEmptyIdExceptionWithAttributeRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_empty_id_attributeRef.xsd"));
        } catch (EmptyIdException error) {
            return;
        }
    ...
    public void testExclusiveContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_exclusive_content.xsd"));
    ...
    public void testMultipleTypesException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_multiple_types.xsd"));
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_multiple_annotation.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/attributeTests/attribute_unsupported_content.xsd"));
