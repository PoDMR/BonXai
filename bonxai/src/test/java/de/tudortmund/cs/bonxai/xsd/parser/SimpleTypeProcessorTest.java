...
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.attribute.InvalidFinalValueException;
...
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.inheritance.MissingSimpleTypeInheritanceException;
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.inheritance.SimpleTypeMultipleInheritanceException;
...
public class SimpleTypeProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCase() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_valid.xsd"));
    ...
    public void testMissingSimpleTypeInheritanceException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_no_inherit.xsd"));
    ...
    public void testInvalidNCNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_invalid_ncname.xsd"));
    ...
    public void testInvalidFinalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_invalid_final.xsd"));
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_empty_id.xsd"));
    ...
    public void testSimpleTypeMultipleInheritanceExceptionWithRestriction() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_multi_inherit.xsd"));
    ...
    public void testSimpleTypeMultipleInheritanceExceptionWithList() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_multi_inherit_list.xsd"));
        } catch (SimpleTypeMultipleInheritanceException error) {
            return;
        }
    ...
    public void testSimpleTypeMultipleInheritanceExceptionWithUnion() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_multi_inherit_union.xsd"));
        } catch (SimpleTypeMultipleInheritanceException error) {
            return;
        }
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_multi_annot.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/simpleTypeTests/simpletype_wrong_content.xsd"));
