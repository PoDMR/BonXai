...
public class ComplexTypeProcessorTest  extends junit.framework.TestCase {
    ...
    public void testValidCase() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_valid.xsd"));
    ...
    public void testInvalidNCNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/attribute_invalid_nCName.xsd"));
    ...
    public void testInvalidMixedValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_invalid_mixed_value.xsd"));
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_empty_id.xsd"));
    ...
    public void testInvalidFinalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_invalid_final_value.xsd"));
    ...
    public void testInvalidBlockValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_invalid_block_value.xsd"));
    ...
    public void testInvalidAbstractException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_invalid_abstract_value.xsd"));
    ...
    public void testComplexTypeMultipleContentExceptionWithSimpleContent() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_multiple_content_simpleContent.xsd"));
    ...
    public void testComplexTypeMultipleContentExceptionWithComplexContent() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_multiple_content_complexContent.xsd"));
        } catch (ComplexTypeMultipleContentException error) {
            return;
        }
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_attribute_is_not_last_in_contentModel_group.xsd"));
    ...
    public void testComplexTypeMultipleContentExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_multiple_content_group.xsd"));
        } catch (ComplexTypeMultipleContentException error) {
            return;
        }
    ...
    public void testIllegalObjectReturnedExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_illegalObject_returned_group.xsd"));
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithAll() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_attribute_is_not_last_in_contentModel_all.xsd"));
        } catch (AttributeIsNotLastInContentModelException error) {
            return;
        }
    ...
    public void testComplexTypeMultipleContentExceptionWithAll() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_multiple_content_all.xsd"));
        } catch (ComplexTypeMultipleContentException error) {
            return;
        }
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithChoice() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_attribute_is_not_last_in_contentModel_choice.xsd"));
        } catch (AttributeIsNotLastInContentModelException error) {
            return;
        }
    ...
    public void testComplexTypeMultipleContentExceptionWithChoice() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_multiple_content_choice.xsd"));
        } catch (ComplexTypeMultipleContentException error) {
            return;
        }
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithSequence() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_attribute_is_not_last_in_contentModel_sequence.xsd"));
        } catch (AttributeIsNotLastInContentModelException error) {
            return;
        }
    ...
    public void testComplexTypeMultipleContentExceptionWithSequence() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_multiple_content_sequence.xsd"));
        } catch (ComplexTypeMultipleContentException error) {
            return;
        }
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttribute() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_anyAttribute_is_not_last_attribute.xsd"));
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttributeGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_anyAttribute_is_not_last_attributeGroup.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
    ...
    public void testIllegalObjectReturnedExceptionWithAttributeGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_illegalObject_returned_attributeGroup.xsd"));
        } catch (IllegalObjectReturnedException error) {
            return;
        }
    ...
    public void testAnyAttributeIsNotLastExceptionWithAnyAttribute() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_anyAttribute_is_not_last_anyAttribute.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_multiple_annotation.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/complexTypeTests/complexType_unsupported_content.xsd"));
