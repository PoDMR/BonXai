...
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.inheritance.ExtensionMultipleParticleException;
...
public class ExtensionProcessorTest extends junit.framework.TestCase {
    ...
    public void testValidCaseWithComplexContent() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_valid.xsd"));
    ...
    public void testValidCaseWithSimpleContent() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_simplecontent_valid.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_attr_group.xsd"));
    ...
    public void testIllegalObjectReturnedExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_illegal_object.xsd"));
    ...
    public void testExtensionMultipleParticleExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_multi_group.xsd"));
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithAll() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_attr_all.xsd"));
        } catch (AttributeIsNotLastInContentModelException error) {
            return;
        }
    ...
    public void testExtensionMultipleParticleExceptionWithAll() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_multi_all.xsd"));
        } catch (ExtensionMultipleParticleException error) {
            return;
        }
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithChoice() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_attr_choice.xsd"));
        } catch (AttributeIsNotLastInContentModelException error) {
            return;
        }
    ...
    public void testExtensionMultipleParticleExceptionWithChoice() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_multi_choice.xsd"));
        } catch (ExtensionMultipleParticleException error) {
            return;
        }
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithSequence() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_attr_sequence.xsd"));
        } catch (AttributeIsNotLastInContentModelException error) {
            return;
        }
    ...
    public void testExtensionMultipleParticleExceptionWithSequence() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_multi_sequence.xsd"));
        } catch (ExtensionMultipleParticleException error) {
            return;
        }
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttributeAndComplexContentExtension() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_anyattribute_attr_pos.xsd"));
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttributeAndSimpleContentExtension() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_simplecontent_anyattribute_attr_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttributeGroupAndComplexContentExtension() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_anyattribute_attrgroup_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
        fail("AnyAttribute is in the wrong position under a ComplexContentextension.");
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttributeGroupAndSimpleContentExtension() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_simplecontent_anyattribute_attrgroup_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
        fail("AnyAttribute is in the wrong position under a SimpleContentextension.");
    ...
    public void testAnyAttributeIsNotLastExceptionWithAnyAttributeAndComplexContentExtension() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_complexcontent_anyattribute_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
        fail("AnyAttribute is in the wrong position under a ComplexContentextension.");
    ...
    public void testAnyAttributeIsNotLastExceptionWithAnyAttributeAndSimpleContentExtension() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_simplecontent_anyattribute_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
        fail("AnyAttribute is in the wrong position under a SimpleContentextension.");
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_multi_annot.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_wrong_content.xsd"));
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_empty_id.xsd"));
    ...
    public void testEmptyInheritanceBaseException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_empty_inheritance_base.xsd"));
    ...
    public void testInvalidQNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/extensionTests/extension_invalid_qname.xsd"));
