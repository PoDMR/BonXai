...
public class SymbolTableRefTest extends junit.framework.TestCase {
    ...
    public final void testCreateSymbolTableRefFromKeyAndElement() {
        SymbolTableRef<Element> reference  = new SymbolTableRef<Element>("reference", new de.tudortmund.cs.bonxai.xsd.Element( "{}element" ));
    }
    ...
    public final void testSetReferenceInSymbolTable2() {
        Element element1 = new de.tudortmund.cs.bonxai.xsd.Element( "{}element" );
        Element element2 = new de.tudortmund.cs.bonxai.xsd.Element( "{}element" );
