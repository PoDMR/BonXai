...
import de.tudortmund.cs.bonxai.converter.dtd2xsd.exceptions.DuplicateAttributeNameException;
import de.tudortmund.cs.bonxai.converter.dtd2xsd.exceptions.DuplicateElementNameException;
import de.tudortmund.cs.bonxai.converter.dtd2xsd.exceptions.UnsupportedDTDParticleException;
...
public class ElementConverterTest extends junit.framework.TestCase {
    ...
    Vector<de.tudortmund.cs.bonxai.xsd.Element> elements;
    ...
    public void setUp() throws Exception {
        ...
        this.elements = new Vector<de.tudortmund.cs.bonxai.xsd.Element>(this.schema.getElements());
        Collections.sort(elements, new Comparator<de.tudortmund.cs.bonxai.xsd.Element>() {

            @Override
            public int compare(de.tudortmund.cs.bonxai.xsd.Element attribute1, de.tudortmund.cs.bonxai.xsd.Element attribute2) {
    ...
    public void testConvert_myElement01() throws Exception {
        ...
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(0);
    ...
    public void testConvert_myElement02() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(1);
    ...
    public void testConvert_myElement03() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(2);
    ...
    public void testConvert_myElement04() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(3);
    ...
    public void testConvert_myElement05() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(4);
    ...
    public void testConvert_myElement06() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(5);
    ...
    public void testConvert_myElement07() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(6);
    ...
    public void testConvert_myElement08() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(7);
    ...
    public void testConvert_myElement09() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(8);
    ...
    public void testConvert_myElement1() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(9);
    ...
    public void testConvert_myElement10() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(10);
    ...
    public void testConvert_myElement11() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(11);
    ...
    public void testConvert_myElement12() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(12);
    ...
    public void testConvert_myElement13() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(13);
    ...
    public void testConvert_myElement14() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(14);
    ...
    public void testConvert_myElement15() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(15);
    ...
    public void testConvert_myElement2() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(16);
    ...
    public void testConvert_myElement3() throws Exception {
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.elements.get(17);
