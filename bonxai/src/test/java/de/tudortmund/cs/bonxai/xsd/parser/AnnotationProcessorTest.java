...
import de.tudortmund.cs.bonxai.xsd.Documentation;
...
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.attribute.EmptyLangException;
...
public class AnnotationProcessorTest extends junit.framework.TestCase{
    ...
    public void testProcessNodeForValidCase() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/annotationTests/annotation_valid.xsd"));
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/annotationTests/annotation_empty_id.xsd"));
    ...
    public void testInvalideAnyUriExceptionInAppinfo() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/annotationTests/annotation_invalid_anyuri_appinfo.xsd"));
    ...
    public void testInvalideAnyUriExceptionInDocumentation() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/annotationTests/annotation_invalid_anyuri_documentation.xsd"));
        } catch (InvalidAnyUriException error) {
            return;
        }
    ...
    public void testEmptyLangException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/annotationTests/annotation_empty_lang.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/annotationTests/annotation_wrong_content.xsd"));
