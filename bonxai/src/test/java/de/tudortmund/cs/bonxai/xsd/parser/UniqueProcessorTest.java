...
public class UniqueProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCase() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_valid.xsd"));
    ...
    public void testInvalidNCNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_invalid_nCName.xsd"));
    ...
    public void testMissingSelectorException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_missing_selector.xsd"));
    ...
    public void testMissingFieldException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_missing_field.xsd"));
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_empty_id.xsd"));
    ...
    public void testDuplicatedSelectorException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_duplicated_selector.xsd"));
    ...
    public void testEmptySelectorException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_empty_selector.xsd"));
    ...
    public void testEmptyFieldException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_empty_field.xsd"));
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_multiple_annotation.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_unsupported_content.xsd"));
    ...
    public void testDuplicateConstraintException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/uniqueTests/unique_duplicate_constraint.xsd"));
