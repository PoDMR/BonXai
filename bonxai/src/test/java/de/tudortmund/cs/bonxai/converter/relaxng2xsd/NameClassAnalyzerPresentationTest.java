...
import de.tudortmund.cs.bonxai.converter.relaxng2xsd.NameClassAnalyzer;
...
public class NameClassAnalyzerPresentationTest {
    ...
    public void testAnalyze() throws Exception {
        ...
        // name-attribute
//        String filePath = new String("tests/de/tudortmund/cs/bonxai/relaxng/tools/rngs/name/name1.rng");
        
        // nameClass: name
//        String filePath = new String("tests/de/tudortmund/cs/bonxai/relaxng/tools/rngs/name/name2.rng");

        // nameClass: anyName
//        String filePath = new String("tests/de/tudortmund/cs/bonxai/relaxng/tools/rngs/name/name3.rng");
...
//        String filePath = new String("tests/de/tudortmund/cs/bonxai/relaxng/tools/rngs/name/name5.rng");

        // nameClass: nsName ns=""
//        String filePath = new String("tests/de/tudortmund/cs/bonxai/relaxng/tools/rngs/name/name6.rng");

        // nameClasses:
        //   <name>test</name>
        //   <anyName/>
//        String filePath = new String("tests/de/tudortmund/cs/bonxai/relaxng/tools/rngs/name/name7.rng");
        ...
        //     </except>
        //   </anyName>
//        String filePath = new String("tests/de/tudortmund/cs/bonxai/relaxng/tools/rngs/name/name10.rng");
