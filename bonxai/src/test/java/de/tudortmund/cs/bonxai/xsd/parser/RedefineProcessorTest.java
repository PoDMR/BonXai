...
import de.tudortmund.cs.bonxai.xsd.RedefinedSchema;
import de.tudortmund.cs.bonxai.xsd.XSDSchema;
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.attribute.EmptyIdException;
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.attribute.InvalidAnyUriException;
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.attribute.MissingSchemaLocationException;
...
public class RedefineProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCase() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/redefineTests/redefine_valid.xsd"));
    ...
    public void testInvalideAnyUriException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/redefineTests/redefine_invalid_anyuri.xsd"));
    ...
    public void testMissingSchemaLocationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/redefineTests/redefine_missing_location.xsd"));
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/redefineTests/redefine_empty_id.xsd"));
    ...
    public void testIllegalObjectReturnedExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/redefineTests/redefine_invalid_object_group.xsd"));
    ...
    public void testIllegalObjectReturnedExceptionWithAttributeGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/redefineTests/redefine_invalid_object_attributegroup.xsd"));
        } catch (IllegalObjectReturnedException error) {
            return;
        }
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/redefineTests/redefine_multi_annot.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/redefineTests/redefine_wrong_content.xsd"));
