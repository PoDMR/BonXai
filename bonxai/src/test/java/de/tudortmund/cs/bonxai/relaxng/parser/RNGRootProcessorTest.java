...
public class RNGRootProcessorTest extends junit.framework.TestCase {
    ...
    public void testRootValidCaseGrammar() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/rootTests/root_grammar.rng"));
    ...
    public void testRootValidCaseChoice() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/rootTests/root_choice.rng"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testRootValidCaseElement() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/rootTests/root_element.rng"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testRootValidCaseExternalRef() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/rootTests/root_externalRef.rng"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testRootValidCaseGroup() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/rootTests/root_group.rng"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testRootValidCaseInterleave() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/rootTests/root_interleave.rng"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testRootValidCaseNotAllowed() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/rootTests/root_notAllowed.rng"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
...
//        try {
//            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/rootTests/root_invalid.rng"));
