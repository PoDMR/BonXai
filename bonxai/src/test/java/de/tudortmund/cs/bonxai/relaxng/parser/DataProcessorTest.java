...
import de.tudortmund.cs.bonxai.relaxng.parser.exceptions.EmptyTypeException;
...
public class DataProcessorTest extends junit.framework.TestCase {
    ...
    public void testValidCase() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/dataTests/data_valid.rng"));
    ...
    public void testInValidCaseWithUnsupportedContentException() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/dataTests/data_invalid_content.rng"));
    ...
    public void testInValidCaseWithInvalidNCNameException() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/dataTests/data_invalid_ncname.rng"));
    ...
    public void testInValidCaseWithEmptyTypeException() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/dataTests/data_invalid_type.rng"));
