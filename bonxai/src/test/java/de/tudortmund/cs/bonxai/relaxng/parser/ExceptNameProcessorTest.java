...
public class ExceptNameProcessorTest extends junit.framework.TestCase {
    ...
    public void testValidCase() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/exceptNameTests/exceptName_valid_any.rng"));
    ...
    public void testInValidCaseWithUnsupportedContentException() throws Exception {
        try {
            rngRootProcessor.processNode(RNGUtilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/relaxng/parser/rngs/exceptNameTests/exceptName_invalid_content.rng"));
