...
public class ProcessorTest extends junit.framework.TestCase {
    ...
    public void testVisitChildren() throws Exception {
        Node node = null;
        try {
            node = Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/processorTests/processor_visit.xsd");
    ...
    public void testGetName_Node_targetNamespace() {
        ...
        Node newNode = null;
        try {
            node = Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/processorTests/processor_getname_node.xsd");
    ...
    public void testGetName_String() throws Exception {
        Node node = null;
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/processorTests/processor_getname_node.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
