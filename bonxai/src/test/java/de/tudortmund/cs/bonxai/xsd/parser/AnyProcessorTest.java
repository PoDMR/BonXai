...
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.attribute.InvalidNamespaceValueException;
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.attribute.InvalidProcessContentsValueException;
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.attribute.countingpattern.CountingPatternMaxOccursIllegalValueException;
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.attribute.countingpattern.CountingPatternMinOccursGreaterThanMaxOccursException;
...
public class AnyProcessorTest extends junit.framework.TestCase {
    ...
    public void testValidCaseWithCountingPattern() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_valid_countingpattern.xsd"));
    ...
    public void testValidCaseWithAnyPattern() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_valid.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
        // Check ComplexType ProductType
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_empty_id.xsd"));
    ...
    public void testCountingPatternMaxOccursIllegalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_invalid_countingpattern_max.xsd"));
    ...
    public void testCountingPatternMinOccursIllegalValueExceptionWithUnbound() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_invalid_countingpattern_min_unbounded.xsd"));
        } catch (CountingPatternMaxOccursIllegalValueException error) {
            return;
        }
    ...
    public void testCountingPatternMinOccursGreaterThanMaxOccursException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_invalid_countingpattern_min_max.xsd"));
    ...
    public void testInvalidProcessContentsValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_invalid_pc.xsd"));
    ...
    public void testInvalidNamespaceValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_invalid_ns.xsd"));
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_multi_annot.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/anyTests/any_wrong_content.xsd"));
