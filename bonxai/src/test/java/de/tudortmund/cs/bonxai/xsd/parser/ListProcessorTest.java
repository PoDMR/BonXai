...
import de.tudortmund.cs.bonxai.xsd.parser.exceptions.type.EmptySimpleContentListTypeException;
...
public class ListProcessorTest extends junit.framework.TestCase {
    ...
    public void testValidCase() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/listTests/list_valid.xsd"));
    ...
    public void testInvalidQNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/listTests/list_invalid_qname.xsd"));
    ...
    public void testEmptySimpleContentListTypeException_1() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/listTests/list_no_base_1.xsd"));
    ...
    public void testEmptySimpleContentListTypeException_2() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/listTests/list_no_base_2.xsd"));
        } catch (EmptySimpleContentListTypeException error) {
            return;
        }
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/listTests/list_empty_id.xsd"));
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/listTests/list_multi_annot.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/listTests/list_wrong_content.xsd"));
