...
public class SequenceProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCaseWithCountingPattern() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_valid_countingPattern.xsd"));
    ...
    public void testValidCaseWithSequencePattern() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_valid_sequence.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
        Element shipment = schema.getElementSymbolTable().getReference("{http://www.w3.org/2001/XMLSchema}shipment").getReference();
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_empty_id.xsd"));
    ...
    public void testCountingPatternMaxOccursIllegalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_maxOccurs_illegal_value.xsd"));
    ...
    public void testCountingPatternMinOccursIllegalValueExceptionWithUnbound() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_minOccurs_illegal_value_unbound.xsd"));
    ...
    public void testCountingPatternMinOccursIllegalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_minOccurs_illegal_value.xsd"));
        } catch (CountingPatternMinOccursIllegalValueException error) {
            return;
        }
    ...
    public void testCountingPatternMinOccursGreaterThanMaxOccursException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_minOccurs_greater_than_maxOccurs.xsd"));
    ...
    public void testIllegalObjectReturnedException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_illegal_object_returned.xsd"));
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_multiple_annotation.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/de/tudortmund/cs/bonxai/xsd/parser/xsds/sequenceTests/sequence_unsupported_content.xsd"));
