...
public class ElementConverter extends ConverterBase {
     ...
     */
    public eu.fox7.bonxai.relaxng.Pattern convertElement(eu.fox7.bonxai.xsd.Element xsdElement, boolean setRef) {
        ...
        if (this.xsdElementDefineRefMap.containsKey(xsdElement)) {
            ...
            eu.fox7.bonxai.relaxng.Element relaxngElement = new Element();
     ...
     */
    private Pattern generatePatternForElementType(eu.fox7.bonxai.xsd.Element element) {
        Pattern returnPattern = null;
     ...
     */
    public Pattern handleSubstitutions(eu.fox7.bonxai.xsd.Element xsdElement, Pattern pattern) {
        /**
        ...
        if (XSD2RelaxNGConverter.HANDLE_SUBSTITUTIONS && this.elementInheritanceInformation.containsKey(xsdElement)) {
            LinkedHashSet<eu.fox7.bonxai.xsd.Element> elementSubstitutions = this.elementInheritanceInformation.get(xsdElement);

            if (elementSubstitutions != null && !elementSubstitutions.isEmpty()) {

                Choice choice = new Choice();
                choice.addPattern(pattern);
                for (Iterator<eu.fox7.bonxai.xsd.Element> it = elementSubstitutions.iterator(); it.hasNext();) {
                    eu.fox7.bonxai.xsd.Element xsdSubstitutionElement = it.next();
