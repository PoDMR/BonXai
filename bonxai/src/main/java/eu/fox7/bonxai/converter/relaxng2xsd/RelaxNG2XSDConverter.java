...
import eu.fox7.bonxai.relaxng.tools.*;
...
import eu.fox7.bonxai.xsd.tools.InterleaveHandler;
 ...
 * RELAX NG object model (eu.fox7.bonxai.relaxng) to the
 * XSD object model (eu.fox7.bonxai.xsd).
 *
...
public class RelaxNG2XSDConverter extends ConverterBase {
    ...
    public XSDSchema convert() throws ConversionFailedException {
    	try {
    		...
    		// Case "Type":
    			for (Iterator<SymbolTableRef<eu.fox7.bonxai.xsd.Type>> it = this.xmlSchema.getTypeSymbolTable().getReferences().iterator(); it.hasNext();) {
    				SymbolTableRef<eu.fox7.bonxai.xsd.Type> symbolTableRefType = it.next();
    				if (!symbolTableRefType.getReference().getNamespace().equals(this.xmlSchema.getTargetNamespace())) {
    					...
    					if (importedSchema != null) {
    						SymbolTable<eu.fox7.bonxai.xsd.Type> typeSymbolTable = (SymbolTable<eu.fox7.bonxai.xsd.Type>) importedSchema.getSchema().getTypeSymbolTable();
