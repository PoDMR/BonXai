...
public class ElementConverter {
    ...
    private HashSet<eu.fox7.bonxai.xsd.Element> alreadyConvertedElements;
    ...
    public ElementConverter(XSDSchema xmlSchema, DocumentTypeDefinition dtd) {
        ...
        this.alreadyConvertedElements = new HashSet<eu.fox7.bonxai.xsd.Element>();
    }
    ...
    public LinkedHashMap<String, ElementWrapper> convert() {
        ...
        LinkedList<eu.fox7.bonxai.xsd.Element> startElements = new LinkedList<eu.fox7.bonxai.xsd.Element>();
        ...
        for (Iterator<eu.fox7.bonxai.xsd.Element> it = startElements.iterator(); it.hasNext();) {
     ...
     */
    private void findStartElements(XSDSchema currentXSDSchema, LinkedList<eu.fox7.bonxai.xsd.Element> startElements) {
     ...
     *
     * @param element       eu.fox7.bonxai.xsd.Element
     * @return  Element     eu.fox7.bonxai.dtd.Element
     */
    public Element convertElement(eu.fox7.bonxai.xsd.Element element) {
    ...
    private Particle convertContentModel(Particle particle, Integer level, LinkedHashMap<Integer, Integer> countingPatternMap) {
        Particle dtdParticle = null;
        level++;
        if (particle instanceof eu.fox7.bonxai.xsd.ElementRef) {

            // Case "ElementRef":

            eu.fox7.bonxai.xsd.ElementRef elementRef = (eu.fox7.bonxai.xsd.ElementRef) particle;
            if (elementRef.getElement() != null) {

                eu.fox7.bonxai.xsd.Element xsdElement = elementRef.getElement();
                DTDNameGenerator dtdNameGenerator = new DTDNameGenerator(xmlSchema);
