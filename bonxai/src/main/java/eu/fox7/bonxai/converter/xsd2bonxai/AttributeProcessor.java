...
class AttributeProcessor {
     ...
     */
    public eu.fox7.bonxai.bonxai.Attribute convertAttributeRef(eu.fox7.bonxai.xsd.AttributeRef xsdAttributeRef) {
        if (xsdAttributeRef.getAttribute() == null) {
            throw new RuntimeException("AttributeRef with empty reference discovered.");
        }

        eu.fox7.bonxai.bonxai.Attribute bonxaiAttribute = convertAttribute(
     ...
     */
    public eu.fox7.bonxai.bonxai.AttributeGroupReference convertAttributeGroupRef(eu.fox7.bonxai.xsd.AttributeGroupRef xsdAttributeGroupRef) {
        if (symbolTable.hasReference(xsdAttributeGroupRef.getAttributeGroup().getLocalName())){
            return new eu.fox7.bonxai.bonxai.AttributeGroupReference(symbolTable.getReference( xsdAttributeGroupRef.getAttributeGroup().getLocalName()));
        }else{
