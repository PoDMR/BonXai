...
public class PatternSimpleTypeConverter extends ConverterBase {
    ...
    public SimpleType generateSimpleTypeForPattern(Pattern pattern, LinkedList<Pattern> parentList) throws Exception {
        ...
        if (pattern instanceof eu.fox7.bonxai.relaxng.Data) {

            // Case: Data

            eu.fox7.bonxai.relaxng.Data data = (eu.fox7.bonxai.relaxng.Data) pattern;
        ...
        } else if (pattern instanceof eu.fox7.bonxai.relaxng.List) {

            // Case: List

            eu.fox7.bonxai.relaxng.List list = (eu.fox7.bonxai.relaxng.List) pattern;
        ...
        } else if (pattern instanceof eu.fox7.bonxai.relaxng.Choice) {

            // Case: Choice

            eu.fox7.bonxai.relaxng.Choice choice = (eu.fox7.bonxai.relaxng.Choice) pattern;
        ...
        } else if (pattern instanceof eu.fox7.bonxai.relaxng.Optional) {

            // Case: Optional

            eu.fox7.bonxai.relaxng.Optional optional = (eu.fox7.bonxai.relaxng.Optional) pattern;
        ...
        } else if (pattern instanceof eu.fox7.bonxai.relaxng.Value) {

            // Case: Value

            eu.fox7.bonxai.relaxng.Value value = (eu.fox7.bonxai.relaxng.Value) pattern;
