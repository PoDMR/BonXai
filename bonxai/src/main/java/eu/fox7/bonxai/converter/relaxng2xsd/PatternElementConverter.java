...
import eu.fox7.bonxai.converter.relaxng2xsd.exceptions.*;
...
public class PatternElementConverter extends ConverterBase {
     ...
     * of the same element
     */
    private HashMap<Element, LinkedList<eu.fox7.bonxai.common.Particle>> alreadyConvertedElements = new HashMap<Element, LinkedList<Particle>>();
    /**
     ...
     */
    private HashMap<Element, HashSet<eu.fox7.bonxai.xsd.Element>> rngElementToxsdElements = new HashMap<Element, HashSet<eu.fox7.bonxai.xsd.Element>>();
    /**
     ...
     *
     */
    private HashMap<String, eu.fox7.bonxai.common.SymbolTableRef<eu.fox7.bonxai.xsd.Group>> refToGroupMap = new HashMap<String, eu.fox7.bonxai.common.SymbolTableRef<eu.fox7.bonxai.xsd.Group>>();
    private HashMap<String, eu.fox7.bonxai.common.SymbolTableRef<eu.fox7.bonxai.xsd.AttributeGroup>> refToAttributeGroupMap = new HashMap<String, eu.fox7.bonxai.common.SymbolTableRef<eu.fox7.bonxai.xsd.AttributeGroup>>();
    ...
    public void convert() throws Exception {
        ...
        for (Iterator<Pattern> it = rootElements.iterator(); it.hasNext();) {
            ...
            if (!(this.patternInformation.get(element) != null && this.patternInformation.get(element).contains("notAllowed"))) {
                ...
                LinkedList<eu.fox7.bonxai.common.Particle> currentParticleList = this.convertElement(element);
                ...
                for (Iterator<Particle> it1 = currentParticleList.iterator(); it1.hasNext();) {
                    ...
                    if (particle instanceof eu.fox7.bonxai.xsd.Element) {
                        ...
                        if (xsdElement.getNamespace().equals(this.xmlSchema.getTargetNamespace()) || xsdElement.getNamespace().equals("")) {
                            ...
                            SymbolTableRef<eu.fox7.bonxai.xsd.Element> strElement = new SymbolTableRef<eu.fox7.bonxai.xsd.Element>(xsdElement.getName(), xsdElement);
//                          SymbolTableRef<eu.fox7.bonxai.xsd.Element> strElement = this.xmlSchema.getElementSymbolTable().updateOrCreateReference(xsdElement.getName(), xsdElement);
     ...
     * @return LinkedList<eu.fox7.bonxai.common.Particle>      result of the conversion
     * @throws Exception
     */
    private LinkedList<eu.fox7.bonxai.common.Particle> convertElement(Element element) throws Exception {
        ...
        LinkedList<eu.fox7.bonxai.common.Particle> resultParticle = new LinkedList<Particle>();
                ...
                if (elementNameInfos.get(currentNameKey) != null) {
                    ...
                    if (currentAnyObject instanceof AnyPattern) {
                        ...
                        if (currentNameKey.startsWith("-")) {
                            ...
                            SymbolTableRef<eu.fox7.bonxai.xsd.Group> strGroup = putParticleIntoGroup(groupName, anyPattern.getNamespace(), newAnyPattern, false);
                    ...
                    eu.fox7.bonxai.xsd.Element xsdElement = new eu.fox7.bonxai.xsd.Element(currentNameKey, typeRef);
                                ...
                                if (!this.usedTopLevelElementNames.contains(xsdElement.getName())) {
                                    ...
                                    if (!checkForDuplicateElement(currentNameKey, element)) {
                                        ...
                                        if (this.alreadyConvertedElements.get(element) != null) {
                                            ...
                                            SymbolTableRef<eu.fox7.bonxai.xsd.Group> strGroup = putParticleIntoGroup(groupName, xsdElement.getNamespace(), xsdElement, false);
                                            eu.fox7.bonxai.common.GroupRef groupRef = new GroupRef(strGroup);
                                            resultParticle.add(groupRef);
                                        }
                                    }
     ...
     * @return SymbolTableRef<eu.fox7.bonxai.xsd.Type>
     * @throws TypeIsNullException
     * @throws Exception
     */
    private SymbolTableRef<eu.fox7.bonxai.xsd.Type> generateTypeForElement(Element element, LinkedList<Pattern> patternList, String localTypeName, Integer countRealElementNames) throws TypeIsNullException, Exception {
        ...
        eu.fox7.bonxai.xsd.Type resultType = null;
        ...
        if (patternsContainingElement.isEmpty() && patternsContainingAttribute.isEmpty() && patternsContainingData.isEmpty() && currentPatternInformation.contains("notAllowed")) {
            ...
            LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> attributeList = this.patternAttributeConverter.convertPatternListToAttributeParticleList(patternsContainingAttribute);
            ...
            boolean mixed = false;
            eu.fox7.bonxai.common.Particle xsdParticle = null;
            LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> attributeList = null;
            ...
            if ((refNameType && (!patternsContainingElement.isEmpty() || !patternsContainingAttribute.isEmpty() || !patternsContainingData.isEmpty())) || !refNameType) {
                ...
                if (patternsContainingElement.size() > 1) {
                    ...
                    eu.fox7.bonxai.common.Particle resultParticle = convertPatternToElementParticleStructure(patternsContainingElement.iterator().next());
                    if (resultParticle != null) {
                        if (resultParticle instanceof eu.fox7.bonxai.xsd.Element || resultParticle instanceof eu.fox7.bonxai.xsd.ElementRef) {
                            SequencePattern sequencePattern = new SequencePattern();
                ...
                if (!refNameType) {
                    if (xsdParticle != null) {
                        ...
                        eu.fox7.bonxai.common.Particle myParticle = null;
                        if (xsdParticle instanceof CountingPattern) {
     ...
     * @return eu.fox7.bonxai.common.Particle      result of the conversion
     * @throws Exception
     */
    private eu.fox7.bonxai.common.Particle convertPatternToElementParticleStructure(Pattern relaxNGPattern) throws Exception {
        eu.fox7.bonxai.common.Particle resultParticle = null;
        if (relaxNGPattern != null && this.patternInformation.get(relaxNGPattern) != null && this.patternInformation.get(relaxNGPattern).contains("element") || relaxNGPattern instanceof Element) {
            if (relaxNGPattern instanceof ZeroOrMore) {
                ...
                if (this.recursiveElements.contains(innerElement)) {
                    ...
                    LinkedList<eu.fox7.bonxai.common.Particle> elementParticles = null;
                    ...
                    if (elementParticles != null && elementParticles.size() > 1) {
                        ...
                        for (Iterator<eu.fox7.bonxai.common.Particle> it = elementParticles.iterator(); it.hasNext();) {
                            eu.fox7.bonxai.common.Particle innerParticle = it.next();
                        ...
                        eu.fox7.bonxai.common.Particle elementParticle = elementParticles.getFirst();
                        resultParticle = elementParticle;
                    }

                } else {
                    if (!(this.patternInformation.get(innerElement) != null && this.patternInformation.get(innerElement).contains("notAllowed"))) {
                        LinkedList<eu.fox7.bonxai.common.Particle> elementParticles = convertElement(innerElement);
...
//                }
                ...
                if (RelaxNG2XSDConverter.REF_TO_GROUP_CONVERSION && this.refToGroupMap.get(ref.getUniqueRefID()) != null) {
                    ...
                    SymbolTableRef<eu.fox7.bonxai.xsd.Group> strGroupDummy = null;
                    ...
                    if (definePatterns.size() > 1) {
                        eu.fox7.bonxai.common.Particle combineParticle = null;
                        ...
                        for (Iterator<Pattern> it = definePatterns.iterator(); it.hasNext();) {
                            ...
                            if (tempParticle != null) {
                                if (!RelaxNG2XSDConverter.INTERLEAVE_APPROXIMATION_OFF) {
                                    if (!(tempParticle instanceof eu.fox7.bonxai.xsd.Element) && !(tempParticle instanceof eu.fox7.bonxai.xsd.ElementRef) && !(tempParticle instanceof eu.fox7.bonxai.common.CountingPattern)) {
                                        allPatternAllowed = false;
                                    }

                                    if (tempParticle instanceof eu.fox7.bonxai.common.CountingPattern) {
                    ...
                    if (RelaxNG2XSDConverter.REF_TO_GROUP_CONVERSION && resultParticle != null && strGroupDummy != null) {
                        SymbolTableRef<eu.fox7.bonxai.xsd.Group> strGroup = this.putParticleIntoGroup(groupName, namespace, resultParticle, true);
                        eu.fox7.bonxai.common.GroupRef groupRef = new GroupRef(strGroup);
     ...
     * @param namespace
     * @param particle
     * @return eu.fox7.bonxai.common.GroupRef
     * @throws ParticleIsNullException
     * @throws Exception
     */
    private SymbolTableRef<eu.fox7.bonxai.xsd.Group> putParticleIntoGroup(String localGroupName, String namespace, eu.fox7.bonxai.common.Particle particle, boolean forceGroupName) throws ParticleIsNullException, Exception {
        ...
        Type type = null;
        if (particleForCheck instanceof eu.fox7.bonxai.common.AllPattern || particleForCheck instanceof eu.fox7.bonxai.common.ChoicePattern || particleForCheck instanceof eu.fox7.bonxai.common.SequencePattern) {
            groupParticleContainer = (ParticleContainer) particle;
        } else { //if (particleForCheck instanceof eu.fox7.bonxai.xsd.Element || particleForCheck instanceof eu.fox7.bonxai.common.AnyPattern || particleForCheck instanceof eu.fox7.bonxai.common.ElementRef) {
            SequencePattern sequencePattern = new SequencePattern();
            sequencePattern.addParticle(particle);
            groupParticleContainer = sequencePattern;

            if (particleForCheck instanceof eu.fox7.bonxai.xsd.Element) {
                eu.fox7.bonxai.xsd.Element currentElement = (eu.fox7.bonxai.xsd.Element) particleForCheck;
                type = currentElement.getType();
            }
        }

        if (groupParticleContainer != null) {
            eu.fox7.bonxai.xsd.Group group = new eu.fox7.bonxai.xsd.Group(fqGroupName, groupParticleContainer);
            SymbolTableRef<eu.fox7.bonxai.xsd.Group> strGroup = this.xmlSchema.getGroupSymbolTable().updateOrCreateReference(group.getName(), group);
     ...
     */
    private void addXSDElementToRNGElementMap(Element rngElement, eu.fox7.bonxai.xsd.Element xsdElement) {
        if (this.rngElementToxsdElements.get(rngElement) != null) {
            this.rngElementToxsdElements.get(rngElement).add(xsdElement);
        } else {
            HashSet<eu.fox7.bonxai.xsd.Element> tempHashSet = new HashSet<eu.fox7.bonxai.xsd.Element>();
    ...
    private void setGeneratedTypesToInnerElements() {
        for (Iterator<Element> it = this.rngElementToxsdElements.keySet().iterator(); it.hasNext();) {
            ...
            if (strType != null) {
                for (Iterator<eu.fox7.bonxai.xsd.Element> it1 = this.rngElementToxsdElements.get(element).iterator(); it1.hasNext();) {
                    eu.fox7.bonxai.xsd.Element xsdElement = it1.next();
    ...
    private SymbolTableRef<Type> generateComplexTypeForRefRecursive(Ref ref) throws Exception {
        ...
        if (refToTypeMap.get(ref.getUniqueRefID()) != null) {
            ...
            LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> refAttributeList = this.patternAttributeConverter.convertPatternListToAttributeParticleList(new HashSet<Pattern>(definePatterns));
            ...
            eu.fox7.bonxai.common.Particle refXSDParticle = null;
            eu.fox7.bonxai.common.Particle resultParticle = convertPatternToElementParticleStructure(group);
            if (resultParticle != null) {
                if (resultParticle instanceof eu.fox7.bonxai.xsd.Element || resultParticle instanceof eu.fox7.bonxai.xsd.ElementRef) {
                    SequencePattern sequencePattern = new SequencePattern();
                    sequencePattern.addParticle(resultParticle);
