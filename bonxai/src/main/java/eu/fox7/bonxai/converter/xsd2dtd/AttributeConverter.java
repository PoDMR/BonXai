...
public class AttributeConverter {
     ...
     */
    public LinkedList<Attribute> convertAttributes(eu.fox7.bonxai.xsd.Element element) {
    ...
    public Attribute convertAttribute(AttributeParticle xsdAttributeParticle) {
        ...
        if (xsdAttributeParticle instanceof eu.fox7.bonxai.xsd.AttributeRef) {
            // Case "AttributeRef":
            eu.fox7.bonxai.xsd.AttributeRef attributeRef = (AttributeRef) xsdAttributeParticle;
            resultAttribute = convertAttribute(attributeRef.getAttribute());
        } else if (xsdAttributeParticle instanceof AnyAttribute) {
            // Case "AnyAttribute":
            return null;
        } else if (xsdAttributeParticle instanceof eu.fox7.bonxai.xsd.Attribute) {
            // Case "Attribute":
            eu.fox7.bonxai.xsd.Attribute xsdAttribute = (eu.fox7.bonxai.xsd.Attribute) xsdAttributeParticle;
