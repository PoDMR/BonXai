...
public class ElementConverter extends ConverterBase {
    ...
    public void convert(DocumentTypeDefinition dtd) throws Exception {
        ...
        if (dtd != null && dtd.getRootElement() != null) {
            ...
            for (Iterator<Element> it = dtd.getElementSymbolTable().getAllReferencedObjects().iterator(); it.hasNext();) {
                ...
                // Convert one element
                eu.fox7.bonxai.xsd.Element xsdElement = this.convertElement(currentElement);
                    ...
                    for (Iterator<Attribute> it1 = currentElement.getAttributes().iterator(); it1.hasNext();) {
                        ...
                        if (xsdElement.getType() != null) {
                            if (xsdElement.getType() instanceof ComplexType) {
                                ...
                                eu.fox7.bonxai.xsd.Attribute currentXSDattribute = attributeConverter.convert(dtd, currentElement, currentAttribute);
                                ...
                                if (currentXSDattribute.getNamespace().equals(targetUri)) { // || currentXSDattribute.getNamespace().equals(DTD2XSDConverter.XMLSCHEMA_NAMESPACE)) {
                                    ...
                                    for (Iterator<AttributeParticle> it2 = currentComplexType.getAttributes().iterator(); it2.hasNext();) {
                                        ...
                                        if (attributeParticle instanceof eu.fox7.bonxai.xsd.Attribute) {
                                            eu.fox7.bonxai.xsd.Attribute attributeForCheck = (eu.fox7.bonxai.xsd.Attribute) attributeParticle;
                                    ...
                                    SymbolTableRef<eu.fox7.bonxai.xsd.Attribute> attributeSymbolTableRef = this.xmlSchema.getAttributeSymbolTable().updateOrCreateReference(currentXSDattribute.getName(), currentXSDattribute);
                                    eu.fox7.bonxai.xsd.AttributeRef currentXSDAttributeRef = new AttributeRef(attributeSymbolTableRef);
                ...
                SymbolTableRef<eu.fox7.bonxai.xsd.Element> elementSymbolTableRef = this.xmlSchema.getElementSymbolTable().updateOrCreateReference(xsdElement.getName(), xsdElement);
                ...
                if (xsdElement.getNamespace().equals(targetUri)) { // || xsdElement.getNamespace().equals(DTD2XSDConverter.XMLSCHEMA_NAMESPACE)) {
                    ...
                    for (Iterator<eu.fox7.bonxai.xsd.Element> it2 = this.xmlSchema.getElements().iterator(); it2.hasNext();) {
                        eu.fox7.bonxai.xsd.Element elementForCheck = it2.next();
     ...
     * @return eu.fox7.bonxai.xsd.Element        The resulting XSD element object
     * @throws Exception        Some different exceptions can be thrown in sub-methods of this method.
     */
    private eu.fox7.bonxai.xsd.Element convertElement(Element dtdElement) throws Exception {
        ...
        eu.fox7.bonxai.xsd.Element xsdElement = new eu.fox7.bonxai.xsd.Element(elementName);
    ...
    private Particle convertParticle(Particle dtdParticle, ComplexType complexType) throws Exception {
         ...
         */
        if ((particle instanceof eu.fox7.bonxai.xsd.ElementRef) || (particle instanceof CountingPattern
                && (((CountingPattern) particle).getParticles().size() == 1)
                && (((CountingPattern) particle).getParticles().getFirst() instanceof eu.fox7.bonxai.xsd.ElementRef))) {
    ...
    private Particle convertDTDParticleRecursive(Particle dtdParticle, ComplexType complexType) throws Exception {
        ...
        if (dtdParticle instanceof ElementRef) {
            ...
            SymbolTableRef<eu.fox7.bonxai.xsd.Element> elementSymbolTableRef = null;
            String elementName = this.generateXSDFQName(dtdElement.getName());
            if (this.xmlSchema.getElementSymbolTable().hasReference(elementName)) {
                ...
                eu.fox7.bonxai.xsd.Element dummyElement = new eu.fox7.bonxai.xsd.Element(elementName);
            ...
            currentParticle = new eu.fox7.bonxai.xsd.ElementRef(elementSymbolTableRef);
