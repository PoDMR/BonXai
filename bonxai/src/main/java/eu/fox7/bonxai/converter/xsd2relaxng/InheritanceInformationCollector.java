...
public class InheritanceInformationCollector {
     ...
     */
    public LinkedHashSet<Type> getAllTypeSubstitutionsForElement(eu.fox7.bonxai.xsd.Element element) {
     ...
     *                                  used.
     */
    public LinkedHashSet<Type> getAllTypeSubstitutionsForElement(eu.fox7.bonxai.xsd.Element element, LinkedHashMap<Type, LinkedHashSet<Type>> inheritanceInformation) {
