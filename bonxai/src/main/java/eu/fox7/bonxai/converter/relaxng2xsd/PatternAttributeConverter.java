...
import eu.fox7.bonxai.converter.relaxng2xsd.exceptions.MultipleAnyAttributeException;
import eu.fox7.bonxai.converter.relaxng2xsd.exceptions.OnlyFullQualifiedNamesAllowedException;
import eu.fox7.bonxai.converter.relaxng2xsd.exceptions.ParticleIsNullException;
import eu.fox7.bonxai.converter.relaxng2xsd.exceptions.TypeIsNullException;
...
public class PatternAttributeConverter extends ConverterBase {
     ...
     * @return LinkedList<eu.fox7.bonxai.xsd.AttributeParticle>        result of the conversion
     * @throws Exception
     */
    public LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> convertPatternListToAttributeParticleList(HashSet<Pattern> patternsContainingAttribute) throws Exception {
        // handle attribute content conversion
        LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> resultAttributeList = new LinkedList<AttributeParticle>();
     ...
     * @return eu.fox7.bonxai.xsd.Type     type, result of the type creation
     * @throws TypeIsNullException
     * @throws Exception
     */
    private eu.fox7.bonxai.xsd.Type generateTypeForAttribute(Attribute attribute, String localTypeName) throws TypeIsNullException, Exception {
     ...
     * @return LinkedList<eu.fox7.bonxai.xsd.AttributeParticle>        result of the conversion, a list of XML XSDSchema attribute particles
     * @throws Exception
     */
    private LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> convertPatternToAttributeParticleList(Pattern relaxNGPattern) throws Exception {
...
//                    Element innerElement = (Element) relaxNGPattern;
     ...
     * @return LinkedList<eu.fox7.bonxai.xsd.AttributeParticle>
     */
    private LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> mergeAttributeLists(LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> attributeList1, LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> attributeList2) throws MultipleAnyAttributeException, OnlyFullQualifiedNamesAllowedException {
     ...
     */
    private void addAttributeParticleToAttributeList(LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> attributeList, eu.fox7.bonxai.xsd.AttributeParticle attributeParticle) throws MultipleAnyAttributeException, OnlyFullQualifiedNamesAllowedException {
        AnyAttribute anyAttributeAlreadyInList = null;

        for (Iterator<eu.fox7.bonxai.xsd.AttributeParticle> it = attributeList.iterator(); it.hasNext();) {
            eu.fox7.bonxai.xsd.AttributeParticle innerAttributeParticle = it.next();
...
//            throw new MultipleAnyAttributeException();
     ...
     * @return LinkedList<eu.fox7.bonxai.xsd.AttributeParticle>    cleaned attributeList as result
     */
    private LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> cleanUpAttributeList(LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> attributeList) {
        LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> newAttributeList = new LinkedList<AttributeParticle>();
        LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> otherAttributeParticles = new LinkedList<AttributeParticle>();
        HashMap<String, LinkedList<eu.fox7.bonxai.xsd.Attribute>> attributeNameInfo = new HashMap<String, LinkedList<eu.fox7.bonxai.xsd.Attribute>>();
        ...
        for (Iterator<AttributeParticle> it = attributeList.iterator(); it.hasNext();) {
            ...
            if (attributeParticle instanceof eu.fox7.bonxai.xsd.Attribute) {
                eu.fox7.bonxai.xsd.Attribute currentAttribute = (eu.fox7.bonxai.xsd.Attribute) attributeParticle;
                if (attributeNameInfo.get(currentAttribute.getName()) != null) {
                    ...
                    LinkedList<eu.fox7.bonxai.xsd.Attribute> newCurrentAttributeList = new LinkedList<eu.fox7.bonxai.xsd.Attribute>();
        ...
        for (Iterator<String> it = attributeNameInfo.keySet().iterator(); it.hasNext();) {
            ...
            if (attributeNameInfo.get(currentAttributeName) != null && attributeNameInfo.get(currentAttributeName).size() > 1) {
                ...
                eu.fox7.bonxai.xsd.Attribute newAttribute = new eu.fox7.bonxai.xsd.Attribute(currentAttributeName);
                ...
                for (Iterator<eu.fox7.bonxai.xsd.Attribute> it1 = attributeNameInfo.get(currentAttributeName).iterator(); it1.hasNext();) {
                    eu.fox7.bonxai.xsd.Attribute currentAttribute = it1.next();
...
//        }
     ...
     * @throws Exception
     */
    private LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> convertAttribute(Attribute attribute) throws Exception {
                ...
                if (attributeNameInfos.get(currentNameKey) != null) {
                    ...
                    if (currentAnyObject instanceof AnyAttribute) {
                        ...
                        if (currentNameKey.startsWith("-")) {
                            ...
                            eu.fox7.bonxai.xsd.AttributeGroup attributeGroup = new eu.fox7.bonxai.xsd.AttributeGroup(attributeGroupName);
                            attributeGroup.addAttributeParticle(newAnyAttribute);

                            SymbolTableRef<eu.fox7.bonxai.xsd.AttributeGroup> strAttributeGroup = this.xmlSchema.getAttributeGroupSymbolTable().updateOrCreateReference(attributeGroupName, attributeGroup);
                    ...
                    eu.fox7.bonxai.xsd.Attribute xsdAttribute = null;
                    if (typeRef != null) {
                        xsdAttribute = new eu.fox7.bonxai.xsd.Attribute(currentNameKey, typeRef);
                        ...
                        xsdAttribute = new eu.fox7.bonxai.xsd.Attribute(currentNameKey);
                        xsdAttribute.setTypeAttr(false);
                    }
                    this.registerNameInMap(xsdAttribute.getName());
                    SymbolTableRef<eu.fox7.bonxai.xsd.Attribute> strAttribute = this.xmlSchema.getAttributeSymbolTable().updateOrCreateReference(xsdAttribute.getName(), xsdAttribute);
                    ...
                    if (xsdAttribute.getNamespace().equals(this.xmlSchema.getTargetNamespace())) {
                        ...
                        if (!usedTopLevelAttributeNames.contains(xsdAttribute.getName())) {
                            ...
                            SymbolTableRef<eu.fox7.bonxai.xsd.Attribute> strAttributeTwo = importedSchema.getSchema().getAttributeSymbolTable().getReference(xsdAttribute.getName());
     ...
     * @return SymbolTableRef<eu.fox7.bonxai.xsd.AttributeGroup>       resulting SymbolTableReference to the generated attributeGroup
     * @throws Exception
     */
    private SymbolTableRef<eu.fox7.bonxai.xsd.AttributeGroup> putAttributeParticleIntoAttributeGroup(String localAttributeGroupName, String namespace, LinkedList<eu.fox7.bonxai.xsd.AttributeParticle> attributeParticles) throws ParticleIsNullException, Exception {
        ...
        eu.fox7.bonxai.xsd.AttributeGroup attributeGroup = new eu.fox7.bonxai.xsd.AttributeGroup(fqAttributeGroupName);
        ...
        SymbolTableRef<eu.fox7.bonxai.xsd.AttributeGroup> strAttributeGroup = this.xmlSchema.getAttributeGroupSymbolTable().updateOrCreateReference(attributeGroup.getName(), attributeGroup);
    ...
    private boolean isAttributeGroupValid(AttributeGroup attributeGroup) {
        ...
        for (Iterator<AttributeParticle> it = attributeGroup.getAttributeParticles().iterator(); it.hasNext();) {
            ...
            if (attributeParticle instanceof eu.fox7.bonxai.xsd.Attribute) {
                ...
                eu.fox7.bonxai.xsd.Attribute attribute = ((AttributeRef) attributeParticle).getAttribute();
                if (this.getMultipleCountNames().contains(attribute.getName())) {
                    return false;
                }
    ...
    private LinkedList<AttributeParticle> replaceAttributeGroupRefsInAttributeParticle(AttributeParticle attributeParticle) {
        ...
        if (attributeParticle instanceof eu.fox7.bonxai.xsd.AttributeRef) {
        ...
        } else if (attributeParticle instanceof eu.fox7.bonxai.xsd.Attribute) {
            newAttributeList.add(attributeParticle);
