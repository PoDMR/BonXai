...
public class AttributeGroupRef extends AttributeParticle {
     ...
     */
    protected eu.fox7.bonxai.common.SymbolTableRef<AttributeGroup> attributeGroupRef;

    /**
     * Creates an AttributeGroupRef object with the passed symbol table
     * reference.
     */
    public AttributeGroupRef (eu.fox7.bonxai.common.SymbolTableRef<AttributeGroup> attributeGroupRef) {
