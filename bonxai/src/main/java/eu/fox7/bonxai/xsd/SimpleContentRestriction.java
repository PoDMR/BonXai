...
public class SimpleContentRestriction extends Inheritance implements SimpleContentInheritance, SimpleTypeInheritance {
    ...
    public SimpleContentRestriction(eu.fox7.bonxai.common.SymbolTableRef<Type> base) {
        super(base);
        enumeration = new LinkedList<String>();
        this.attributes = new LinkedList<AttributeParticle>();
    }

    public SimpleContentRestriction(eu.fox7.bonxai.common.SymbolTableRef<Type> base, SimpleType anonymousSimpleType) {
        super(base);
        enumeration = new LinkedList<String>();
        this.attributes = new LinkedList<AttributeParticle>();
