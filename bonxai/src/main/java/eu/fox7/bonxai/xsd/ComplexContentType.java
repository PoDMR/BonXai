...
public class ComplexContentType extends Content {
     ...
     */
    private eu.fox7.bonxai.common.Particle particle;
    /**
     ...
     * @return returnCopy
     */
    public eu.fox7.bonxai.common.Particle getParticle() {
     ...
     * @param val
     */
    public void setParticle(eu.fox7.bonxai.common.Particle particle) {
        this.particle = particle;
    }
}
