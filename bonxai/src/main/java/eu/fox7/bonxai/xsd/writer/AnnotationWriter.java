...
public abstract class AnnotationWriter {
    ...
    protected static void writeAnnotation(Node root, Annotationable annotationable, FoundElements foundElements) {
        if (annotationable.getAnnotation() != null) {
            ...
            foundElements.setXSDPrefix(annotNode);
            for (int i = 0; i < annotationable.getAnnotation().getDocumentations().size(); i++) {
                ...
                foundElements.setXSDPrefix(docNode);
            ...
            for (int i = 0; i < annotationable.getAnnotation().getAppInfos().size(); i++) {
                ...
                foundElements.setXSDPrefix(appNode);
