...
public class KeyRef extends SimpleConstraint {
    ...
    protected eu.fox7.bonxai.common.SymbolTableRef<SimpleConstraint> keyRef;

    public KeyRef (String name, String selector, eu.fox7.bonxai.common.SymbolTableRef<SimpleConstraint> keyRef) {
         super(name, selector);
         this.keyRef = keyRef;
    }
