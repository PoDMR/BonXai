...
public class XSDWriter {
     ...
     * @param foundElements
     */
    protected void writeGroups(Node root, Collection<eu.fox7.bonxai.xsd.Group> groups, FoundElements foundElements) {
        for (Group g : groups) {
     ...
     * @param foundElements
     */
    protected void writeElements(Node root, LinkedList<eu.fox7.bonxai.xsd.Element> elements, FoundElements foundElements) {
        for (eu.fox7.bonxai.xsd.Element e : elements) {
