...
public class XSDSchema {
     ...
     * tag.
     */
    protected LinkedList<SymbolTableRef<eu.fox7.bonxai.xsd.Group>> groups;
    /**
    ...
    public XSDSchema() {
        ...
        groups = new LinkedList<SymbolTableRef<eu.fox7.bonxai.xsd.Group>>();
        ...
        groupSymbolTable = new SymbolTable<eu.fox7.bonxai.xsd.Group>();
     ...
     * with its local name in the form "{<namespace>}<localName>".
     */
    public SymbolTableFoundation<eu.fox7.bonxai.xsd.Group> getGroupSymbolTable() {
     ...
     * neccessary when parsing an XSD!
     */
    public void setGroupSymbolTable(SymbolTableFoundation<eu.fox7.bonxai.xsd.Group> table) {
     ...
     */
    public LinkedList<eu.fox7.bonxai.xsd.Group> getGroups() {
        LinkedList<eu.fox7.bonxai.xsd.Group> list = new LinkedList<eu.fox7.bonxai.xsd.Group>();

        if (groups != null) {
            for (SymbolTableRef<eu.fox7.bonxai.xsd.Group> st : groups) {
                list.add(st.getReference());
            }
        }
        return list;
     ...
     */
    public void addGroup(SymbolTableRef<eu.fox7.bonxai.xsd.Group> val) {
        this.groups.add(val);
    }
