package eu.fox7.bonxai.dtd.parser;
...
import eu.fox7.bonxai.dtd.parser.exceptions.DuplicateAttributeNameException;
import eu.fox7.bonxai.dtd.parser.exceptions.DuplicateElementNameException;
...
public class DTDEventHandler implements LexicalHandler, DeclHandler, DTDHandler {
    ...
    public void startDTD(String rootElementName, String publicId, String systemId) throws SAXException {
        ...
        this.dtd.setRootElementRef(new eu.fox7.bonxai.dtd.ElementRef(this.dtd.registerElementFromContentModel(new Element(rootElementName))));
        if (getDebug()) {
