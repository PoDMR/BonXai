...
public class DocumentTypeDefinition {
     ...
     */
    private eu.fox7.bonxai.dtd.ElementRef rootElementRef;
    /**
     * This SymbolTable holds references for ALL elements of the DTD
     */
    private SymbolTable<eu.fox7.bonxai.dtd.Element> elementSymbolTable;
    /**
    ...
    public DocumentTypeDefinition() {
        this.elementSymbolTable = new SymbolTable<eu.fox7.bonxai.dtd.Element>();
     ...
     * @return elementSymbolTable - SymbolTable<eu.fox7.bonxai.dtd.Element>
     */
    public SymbolTable<eu.fox7.bonxai.dtd.Element> getElementSymbolTable() {
     ...
     * @param element
     * @return element - SymbolTableRef<eu.fox7.bonxai.dtd.Element>
     */
    public SymbolTableRef<eu.fox7.bonxai.dtd.Element> registerElementFromContentModel(eu.fox7.bonxai.dtd.Element element) {
     ...
     * @return elementSymbolTable - SymbolTable<eu.fox7.bonxai.dtd.InternalEntity>
     */
    public SymbolTable<eu.fox7.bonxai.dtd.InternalEntity> getInternalEntitySymbolTable() {
     ...
     * @return elementSymbolTable - SymbolTable<eu.fox7.bonxai.dtd.InternalEntity>
     */
    public SymbolTable<eu.fox7.bonxai.dtd.ExternalEntity> getExternalEntitySymbolTable() {
     ...
     * @return elementSymbolTable - SymbolTable<eu.fox7.bonxai.dtd.Notation>
     */
    public SymbolTable<eu.fox7.bonxai.dtd.Notation> getNotationSymbolTable() {
