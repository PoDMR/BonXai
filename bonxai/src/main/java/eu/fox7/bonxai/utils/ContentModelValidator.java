...
import eu.fox7.bonxai.utils.exceptions.RecursiveContentModelException;
import eu.fox7.bonxai.utils.exceptions.UPAViolationException;
...
public class ContentModelValidator {
    ...
    protected int translateTermToFSA(int s, Particle particle, LinkedList<String> fG) throws RecursiveContentModelException {
        ...
        if (particle instanceof AnyPattern) {
            ...
            } else if (group instanceof eu.fox7.bonxai.xsd.Group) {
                eu.fox7.bonxai.xsd.Group g = (eu.fox7.bonxai.xsd.Group) group;
