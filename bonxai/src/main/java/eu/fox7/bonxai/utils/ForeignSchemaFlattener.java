...
import eu.fox7.bonxai.utils.exceptions.IllegalAttributeGroupRedefinitionException;
import eu.fox7.bonxai.utils.exceptions.IllegalGlobalAttributeRedefinitionException;
import eu.fox7.bonxai.utils.exceptions.IllegalGlobalElementRedefinitionException;
import eu.fox7.bonxai.utils.exceptions.IllegalGroupRedefinitionException;
import eu.fox7.bonxai.utils.exceptions.IllegalKeyRedefinitionException;
import eu.fox7.bonxai.utils.exceptions.IllegalRedefinitionException;
import eu.fox7.bonxai.utils.exceptions.IllegalTypeRedefinitionException;
...
public class ForeignSchemaFlattener {
    ...
    private void evolveSymbolTables( XSDSchema schema ) {
        ...
        if ( schema.getGroupSymbolTable() instanceof SymbolTable<?> ) {
            schema.setGroupSymbolTable(
                new MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Group>(
                    (SymbolTable<eu.fox7.bonxai.xsd.Group>)schema.getGroupSymbolTable()
                )
            );
        }
        ...
        if ( schema.getElementSymbolTable() instanceof SymbolTable<?> ) {
            schema.setElementSymbolTable(
                new MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Element>(
                    (SymbolTable<eu.fox7.bonxai.xsd.Element>)schema.getElementSymbolTable()
                )
            );
         }
    ...
    throws IllegalRedefinitionException {
        ...
        Set<eu.fox7.bonxai.xsd.Group> groupSet = meta.getGroups();
        ...
        for( eu.fox7.bonxai.xsd.Group group: groupSet ) {
    ...
    throws IllegalGroupRedefinitionException {
        ...
        HashSet<String> baseGroupNames = this.mapSymbolTableRefNames(
            ((MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Group>)(base.getGroupSymbolTable())).getAllReferences()
        );
        for( LinkedList<SymbolTableRef<eu.fox7.bonxai.xsd.Group>> groupList: ((MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Group>)(foreign.getGroupSymbolTable())).getAllReferences() ) {
            if ( baseGroupNames.contains( groupList.peek().getKey() )
              && ((MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Group>)(base.getGroupSymbolTable())).getReference( groupList.peek().getKey() ).getReference() != null
              && !overwrite.contains( groupList.peek().getKey() ) ) {
                throw new IllegalGroupRedefinitionException( groupList.peek().getKey() );
            }
            for( SymbolTableRef<eu.fox7.bonxai.xsd.Group> groupRef: groupList ) {
                // Add the merged group to the corresponding symboltable
                ((MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Group>)(base.getGroupSymbolTable())).addReference( groupRef );
    ...
    throws IllegalGlobalElementRedefinitionException {
        ...
        HashSet<String> baseGlobalElementNames = this.mapSymbolTableRefNames(
            ((MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Element>)(base.getElementSymbolTable())).getAllReferences()
        );
        for( LinkedList<SymbolTableRef<eu.fox7.bonxai.xsd.Element>> globalElementList: ((MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Element>)(foreign.getElementSymbolTable())).getAllReferences() ) {
            if ( baseGlobalElementNames.contains( globalElementList.peek().getKey() )
              && ((MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Element>)(base.getElementSymbolTable())).getReference( globalElementList.peek().getKey() ).getReference() != null ) {
                throw new IllegalGlobalElementRedefinitionException( globalElementList.peek().getKey() );
            }
            for( SymbolTableRef<eu.fox7.bonxai.xsd.Element> globalElementRef: globalElementList ) {
                // Add the merged element to the corresponding symboltable
                ((MultiReferenceSymbolTable<eu.fox7.bonxai.xsd.Element>)(base.getElementSymbolTable())).addReference( globalElementRef );
     ...
     */
    private HashSet<String> mapGroupNames( Set<eu.fox7.bonxai.xsd.Group> groups ) {
        HashSet<String> map = new HashSet<String>();
        for ( eu.fox7.bonxai.xsd.Group group: groups ) {
