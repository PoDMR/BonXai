...
public class ElementRef extends Particle {
     ...
     */
    protected SymbolTableRef<de.tudortmund.cs.bonxai.dtd.Element> reference;

    /**
     * Constructor of class ElementRef.
     * @param reference
     */
    public ElementRef(SymbolTableRef<de.tudortmund.cs.bonxai.dtd.Element> reference) {
        this.reference = reference;
    }

    /***
     * Method getElement returns the concrete element
     * @return referenced Element (de.tudortmund.cs.bonxai.dtd.Element)
     */
    public de.tudortmund.cs.bonxai.dtd.Element getElement() {
        if (reference != null) {
    ...
    public void setReference(SymbolTableRef<de.tudortmund.cs.bonxai.dtd.Element> reference) {
        this.reference = reference;
    }
