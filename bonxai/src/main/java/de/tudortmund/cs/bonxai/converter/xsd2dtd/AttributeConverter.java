...
public class AttributeConverter {
     ...
     */
    public LinkedList<Attribute> convertAttributes(de.tudortmund.cs.bonxai.xsd.Element element) {
    ...
    public Attribute convertAttribute(AttributeParticle xsdAttributeParticle) {
        ...
        if (xsdAttributeParticle instanceof de.tudortmund.cs.bonxai.xsd.AttributeRef) {
            // Case "AttributeRef":
            de.tudortmund.cs.bonxai.xsd.AttributeRef attributeRef = (AttributeRef) xsdAttributeParticle;
            resultAttribute = convertAttribute(attributeRef.getAttribute());
        } else if (xsdAttributeParticle instanceof AnyAttribute) {
            // Case "AnyAttribute":
            return null;
        } else if (xsdAttributeParticle instanceof de.tudortmund.cs.bonxai.xsd.Attribute) {
            // Case "Attribute":
            de.tudortmund.cs.bonxai.xsd.Attribute xsdAttribute = (de.tudortmund.cs.bonxai.xsd.Attribute) xsdAttributeParticle;
