...
import de.tudortmund.cs.bonxai.converter.dtd2xsd.exceptions.*;
...
public class ElementConverter extends ConverterBase {
    ...
    public void convert(DocumentTypeDefinition dtd) throws Exception {
        ...
        if (dtd != null && dtd.getRootElement() != null) {
            ...
            for (Iterator<Element> it = dtd.getElementSymbolTable().getAllReferencedObjects().iterator(); it.hasNext();) {
                ...
                // Convert one element
                de.tudortmund.cs.bonxai.xsd.Element xsdElement = this.convertElement(currentElement);
                    ...
                    for (Iterator<Attribute> it1 = currentElement.getAttributes().iterator(); it1.hasNext();) {
                        ...
                        if (xsdElement.getType() != null) {
                            if (xsdElement.getType() instanceof ComplexType) {
                                ...
                                de.tudortmund.cs.bonxai.xsd.Attribute currentXSDattribute = attributeConverter.convert(dtd, currentElement, currentAttribute);
                                ...
                                if (currentXSDattribute.getNamespace().equals(targetUri)) { // || currentXSDattribute.getNamespace().equals(DTD2XSDConverter.XMLSCHEMA_NAMESPACE)) {
                                    ...
                                    for (Iterator<AttributeParticle> it2 = currentComplexType.getAttributes().iterator(); it2.hasNext();) {
                                        ...
                                        if (attributeParticle instanceof de.tudortmund.cs.bonxai.xsd.Attribute) {
                                            de.tudortmund.cs.bonxai.xsd.Attribute attributeForCheck = (de.tudortmund.cs.bonxai.xsd.Attribute) attributeParticle;
                                    ...
                                    SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Attribute> attributeSymbolTableRef = this.xmlSchema.getAttributeSymbolTable().updateOrCreateReference(currentXSDattribute.getName(), currentXSDattribute);
                                    de.tudortmund.cs.bonxai.xsd.AttributeRef currentXSDAttributeRef = new AttributeRef(attributeSymbolTableRef);
                ...
                SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element> elementSymbolTableRef = this.xmlSchema.getElementSymbolTable().updateOrCreateReference(xsdElement.getName(), xsdElement);
                ...
                if (xsdElement.getNamespace().equals(targetUri)) { // || xsdElement.getNamespace().equals(DTD2XSDConverter.XMLSCHEMA_NAMESPACE)) {
                    ...
                    for (Iterator<de.tudortmund.cs.bonxai.xsd.Element> it2 = this.xmlSchema.getElements().iterator(); it2.hasNext();) {
                        de.tudortmund.cs.bonxai.xsd.Element elementForCheck = it2.next();
     ...
     * @return de.tudortmund.cs.bonxai.xsd.Element        The resulting XSD element object
     * @throws Exception        Some different exceptions can be thrown in sub-methods of this method.
     */
    private de.tudortmund.cs.bonxai.xsd.Element convertElement(Element dtdElement) throws Exception {
        ...
        de.tudortmund.cs.bonxai.xsd.Element xsdElement = new de.tudortmund.cs.bonxai.xsd.Element(elementName);
    ...
    private Particle convertParticle(Particle dtdParticle, ComplexType complexType) throws Exception {
         ...
         */
        if ((particle instanceof de.tudortmund.cs.bonxai.xsd.ElementRef) || (particle instanceof CountingPattern
                && (((CountingPattern) particle).getParticles().size() == 1)
                && (((CountingPattern) particle).getParticles().getFirst() instanceof de.tudortmund.cs.bonxai.xsd.ElementRef))) {
    ...
    private Particle convertDTDParticleRecursive(Particle dtdParticle, ComplexType complexType) throws Exception {
        ...
        if (dtdParticle instanceof ElementRef) {
            ...
            SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element> elementSymbolTableRef = null;
            String elementName = this.generateXSDFQName(dtdElement.getName());
            if (this.xmlSchema.getElementSymbolTable().hasReference(elementName)) {
                ...
                de.tudortmund.cs.bonxai.xsd.Element dummyElement = new de.tudortmund.cs.bonxai.xsd.Element(elementName);
            ...
            currentParticle = new de.tudortmund.cs.bonxai.xsd.ElementRef(elementSymbolTableRef);
