...
public abstract class ConverterBase {
     ...
     */
    protected HashMap<de.tudortmund.cs.bonxai.xsd.Element, SymbolTableRef<LinkedList<Define>>> xsdElementDefineRefMap;
    /**
     * types
     */
    protected HashMap<de.tudortmund.cs.bonxai.xsd.Type, SymbolTableRef<LinkedList<Define>>> xsdTypeDefineRefMap;
    /**
     * groups
     */
    protected HashMap<de.tudortmund.cs.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>> xsdGroupDefineRefMap;
    /**
     * attributeGroups
     */
    protected HashMap<de.tudortmund.cs.bonxai.xsd.AttributeGroup, SymbolTableRef<LinkedList<Define>>> xsdAttributeGroupDefineRefMap;
    /**
     * attributes
     */
    protected HashMap<de.tudortmund.cs.bonxai.xsd.Attribute, SymbolTableRef<LinkedList<Define>>> xsdAttributeDefineRefMap;
    /**
    ...
    public ConverterBase(XSDSchema xmlSchema, RelaxNGSchema relaxng) {
        ...
        this.xsdAttributeDefineRefMap = new HashMap<de.tudortmund.cs.bonxai.xsd.Attribute, SymbolTableRef<LinkedList<Define>>>();
        this.xsdAttributeGroupDefineRefMap = new HashMap<AttributeGroup, SymbolTableRef<LinkedList<Define>>>();
        this.xsdElementDefineRefMap = new HashMap<de.tudortmund.cs.bonxai.xsd.Element, SymbolTableRef<LinkedList<Define>>>();
        this.xsdGroupDefineRefMap = new HashMap<de.tudortmund.cs.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>>();
    ...
    public ConverterBase(XSDSchema xmlSchema,
            ...
            HashMap<de.tudortmund.cs.bonxai.xsd.Attribute, SymbolTableRef<LinkedList<Define>>> xsdAttributeDefineRefMap,
            HashMap<AttributeGroup, SymbolTableRef<LinkedList<Define>>> xsdAttributeGroupDefineRefMap,
            HashMap<de.tudortmund.cs.bonxai.xsd.Element, SymbolTableRef<LinkedList<Define>>> xsdElementDefineRefMap,
            HashMap<de.tudortmund.cs.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>> xsdGroupDefineRefMap,
     ...
     */
    public HashMap<de.tudortmund.cs.bonxai.xsd.Element, SymbolTableRef<LinkedList<Define>>> getXsdElementDefineRefMap() {
     ...
     */
    public void setXsdElementDefineRefMap(HashMap<de.tudortmund.cs.bonxai.xsd.Element, SymbolTableRef<LinkedList<Define>>> xsdElementDefineRefMap) {
        this.xsdElementDefineRefMap = xsdElementDefineRefMap;
    }
     ...
     */
    public HashMap<de.tudortmund.cs.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>> getXsdGroupDefineRefMap() {
     ...
     */
    public void setXsdGroupDefineRefMap(HashMap<de.tudortmund.cs.bonxai.xsd.Group, SymbolTableRef<LinkedList<Define>>> xsdGroupDefineRefMap) {
        this.xsdGroupDefineRefMap = xsdGroupDefineRefMap;
    }
     ...
     */
    public HashMap<de.tudortmund.cs.bonxai.xsd.Attribute, SymbolTableRef<LinkedList<Define>>> getXsdAttributeDefineRefMap() {
     ...
     */
    public void setXsdAttributeDefineRefMap(HashMap<de.tudortmund.cs.bonxai.xsd.Attribute, SymbolTableRef<LinkedList<Define>>> xsdAttributeDefineRefMap) {
        this.xsdAttributeDefineRefMap = xsdAttributeDefineRefMap;
    }
     ...
     */
    public String registerDummyInDefineRefMap(de.tudortmund.cs.bonxai.xsd.Element xsdElement) {
     ...
     * @return String       name of the registered define containing a dummy-object
     */
    public String registerDummyInDefineRefMap(de.tudortmund.cs.bonxai.xsd.Attribute xsdAttribute) {
     ...
     * @return String              name of the registered define containing a dummy-object
     */
    public String registerDummyInDefineRefMap(de.tudortmund.cs.bonxai.xsd.AttributeGroup xsdAttributeGroup) {
     ...
     * @return String     name of the registered define containing a dummy-object
     */
    public String registerDummyInDefineRefMap(de.tudortmund.cs.bonxai.xsd.Group xsdGroup) {
     ...
     * @return String     name of the registered define containing a dummy-object
     */
    public String registerDummyInDefineRefMap(de.tudortmund.cs.bonxai.xsd.Type xsdType) {
    ...
    protected void collectAttributeNamesWithIDTypeRecursively(XSDSchema xmlSchema, LinkedHashSet<String> attributeNamesWithIDType, LinkedHashSet<XSDSchema> alreadySeenSchemas) {
        ...
        for (Iterator<de.tudortmund.cs.bonxai.xsd.Attribute> it = xmlSchema.getAttributes().iterator(); it.hasNext();) {
            de.tudortmund.cs.bonxai.xsd.Attribute attribute = it.next();
        ...
        for (Iterator<de.tudortmund.cs.bonxai.xsd.Type> it = xmlSchema.getTypeSymbolTable().getAllReferencedObjects().iterator(); it.hasNext();) {
            de.tudortmund.cs.bonxai.xsd.Type type = it.next();

            if (type instanceof ComplexType) {
                ComplexType complexType = (ComplexType) type;

                // Check attributes from all complexTypes
                for (Iterator<de.tudortmund.cs.bonxai.xsd.AttributeParticle> it1 = complexType.getAttributes().iterator(); it1.hasNext();) {
                    de.tudortmund.cs.bonxai.xsd.AttributeParticle attributeParticle = it1.next();
                ...
                if (complexType.getContent() != null && complexType.getContent() instanceof ComplexContentType) {
                    ...
                    if (complexContentType.getInheritance() != null && complexContentType.getInheritance() instanceof ComplexContentExtension) {
                        ...
                        for (Iterator<de.tudortmund.cs.bonxai.xsd.AttributeParticle> it1 = complexContentExtension.getAttributes().iterator(); it1.hasNext();) {
                            de.tudortmund.cs.bonxai.xsd.AttributeParticle attributeParticle = it1.next();
                            attributeNamesWithIDType.addAll(this.collectAttributeNamesWithIDTypeFromAttributeParticle(attributeParticle));
                        }
                        ...
                        for (Iterator<de.tudortmund.cs.bonxai.xsd.AttributeParticle> it1 = complexContentRestriction.getAttributes().iterator(); it1.hasNext();) {
                            de.tudortmund.cs.bonxai.xsd.AttributeParticle attributeParticle = it1.next();
                            attributeNamesWithIDType.addAll(this.collectAttributeNamesWithIDTypeFromAttributeParticle(attributeParticle));
                        }
                    }
                    ...
                    if (simpleContentType.getInheritance() != null && simpleContentType.getInheritance() instanceof SimpleContentExtension) {
                        ...
                        for (Iterator<de.tudortmund.cs.bonxai.xsd.AttributeParticle> it1 = simpleContentExtension.getAttributes().iterator(); it1.hasNext();) {
                            de.tudortmund.cs.bonxai.xsd.AttributeParticle attributeParticle = it1.next();
                            attributeNamesWithIDType.addAll(this.collectAttributeNamesWithIDTypeFromAttributeParticle(attributeParticle));
                        }
                        ...
                        for (Iterator<de.tudortmund.cs.bonxai.xsd.AttributeParticle> it1 = simpleContentRestriction.getAttributes().iterator(); it1.hasNext();) {
                            de.tudortmund.cs.bonxai.xsd.AttributeParticle attributeParticle = it1.next();
                            attributeNamesWithIDType.addAll(this.collectAttributeNamesWithIDTypeFromAttributeParticle(attributeParticle));
                        }
                    }
        ...
        for (Iterator<de.tudortmund.cs.bonxai.xsd.AttributeGroup> it = xmlSchema.getAttributeGroups().iterator(); it.hasNext();) {
            de.tudortmund.cs.bonxai.xsd.AttributeGroup attributeGroup = it.next();
    ...
    private LinkedHashSet<String> collectAttributeNamesWithIDTypeFromAttributeParticle(AttributeParticle attributeParticle) {
        ...
        if (attributeParticle instanceof de.tudortmund.cs.bonxai.xsd.Attribute) {
        ...
        } else if (attributeParticle instanceof de.tudortmund.cs.bonxai.xsd.AttributeRef) {

            // Case "attributeRef":
            de.tudortmund.cs.bonxai.xsd.AttributeRef attributeRef = (AttributeRef) attributeParticle;
            ...
            // Case "attributeGroup":
            de.tudortmund.cs.bonxai.xsd.AttributeGroup attributeGroup = (AttributeGroup) attributeParticle;
            ...
            de.tudortmund.cs.bonxai.xsd.AttributeGroupRef attributeGroupRef = (AttributeGroupRef) attributeParticle;
