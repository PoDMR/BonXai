...
import de.tudortmund.cs.bonxai.relaxng.parser.exceptions.NodeIsNullException;
                ...
                for (int i = 0; i < attributes.getLength(); i++) {
                    if ((attributes.item(i)).getNodeName().startsWith("xmlns")) {
                        ...
                        if (currentNode.getNodeName().equals("xmlns")) {
                            ...
                            this.rngSchema.getNamespaceList().addIdentifiedNamespace(new IdentifiedNamespace(currentNode.getLocalName(), currentNode.getNodeValue()));
                        }
                    }
                }
            }
