...
public class SimpleTypeConverter extends ConverterBase {
     ...
     */
    public Pattern handleSubstitutions(de.tudortmund.cs.bonxai.xsd.SimpleType simpleType, Pattern pattern, boolean convertAttributes) {
        /**
        ...
        if (XSD2RelaxNGConverter.HANDLE_SUBSTITUTIONS && this.typeInheritanceInformation.containsKey(simpleType)) {
            LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Type> typeSubstitutions = this.typeInheritanceInformation.get(simpleType);
