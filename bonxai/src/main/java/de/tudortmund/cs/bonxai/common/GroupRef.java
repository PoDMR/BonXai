...
public class GroupRef extends Particle {
    ...
    protected SymbolTableRef<? extends de.tudortmund.cs.bonxai.common.Group> groupRef;

    public GroupRef (SymbolTableRef<? extends de.tudortmund.cs.bonxai.common.Group> groupRef) {
     ...
     */
    public de.tudortmund.cs.bonxai.common.Group getGroup () {
