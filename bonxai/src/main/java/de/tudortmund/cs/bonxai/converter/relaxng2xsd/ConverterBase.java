...
public abstract class ConverterBase {
    ...
    protected ImportedSchema updateOrCreateImportedSchema(String namespace) throws Exception {
        ...
        String schemaLocation = "importedSchema_" + this.xmlSchema.getNamespaceList().getNamespaceByUri(namespace).getIdentifier() + ".xsd";
        ...
        IdentifiedNamespace xmlSchemaIdentifiedNamespace = new IdentifiedNamespace("xs", XSD2DTDConverter.XMLSCHEMA_NAMESPACE);
