...
import de.tudortmund.cs.bonxai.common.DualHashtableElement;

/**
 * Class representing an import statement in Bonxai
 */
public class Import implements DualHashtableElement {
    ...
    /**
     * Returns string representation for string comparison.
     */
    @Override
