...
class ParticleProcessor {
    ...
    public Particle convertParticle(Particle particle) {
        ...
        if (particle instanceof ParticleContainer) {
            ...
            resultParticle = convertElement((de.tudortmund.cs.bonxai.xsd.Element) particle);
     ...
     */
    public de.tudortmund.cs.bonxai.bonxai.Element convertElement(de.tudortmund.cs.bonxai.xsd.Element xsdElement) {
        notifyListeners(xsdElement);

        de.tudortmund.cs.bonxai.bonxai.Element bonxaiElement = new de.tudortmund.cs.bonxai.bonxai.Element(
     ...
     * references.
     */
    public de.tudortmund.cs.bonxai.bonxai.Element convertElementRef(ElementRef elementRef) {
        notifyListeners(elementRef);

        de.tudortmund.cs.bonxai.xsd.Element element =
            (de.tudortmund.cs.bonxai.xsd.Element) elementRef.getElement();
        if (element == null) {
    ...
    public GroupRef convertGroupRef(GroupRef groupRef) {
        ...
        de.tudortmund.cs.bonxai.xsd.Group group =
            (de.tudortmund.cs.bonxai.xsd.Group) groupRef.getGroup();
        if (group == null) {
