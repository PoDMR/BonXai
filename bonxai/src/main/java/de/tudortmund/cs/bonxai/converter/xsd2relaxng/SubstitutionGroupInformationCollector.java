 ...
 * "BlockFinalSpreadingHandler" in package "de.tudortmund.cs.bonxai.xsd.tools".
 *
 * @author Lars Schmidt
 */
public class SubstitutionGroupInformationCollector {
    ...
    private HashMap<SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element>, HashSet<SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element>>> substitutionElements = new HashMap<SymbolTableRef<Element>, HashSet<SymbolTableRef<Element>>>();
    ...
    private void collectBaseInformation(XSDSchema xmlSchema) {
        ...
        HashMap<SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element>, HashSet<SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element>>> currentSubstitutionElementsMap = xmlSchema.getSubstitutionElements();
        for (Iterator<SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element>> it = currentSubstitutionElementsMap.keySet().iterator(); it.hasNext();) {
            SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element> stRefElementHead = it.next();

            if (substitutionElements.containsKey(stRefElementHead)) {
                HashSet<SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element>> targetSet = substitutionElements.get(stRefElementHead);
        ...
        for (Iterator<SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element>> it = substitutionElements.keySet().iterator(); it.hasNext();) {
            SymbolTableRef<de.tudortmund.cs.bonxai.xsd.Element> stRefElementHead = it.next();
