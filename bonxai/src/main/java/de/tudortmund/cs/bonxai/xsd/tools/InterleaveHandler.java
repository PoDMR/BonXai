...
import de.tudortmund.cs.bonxai.xsd.automaton.ParticleAutomatons.ParticleAutomatonFactory;
import de.tudortmund.cs.bonxai.xsd.automaton.ParticleAutomatons.ProductParticleAutomaton;
import de.tudortmund.cs.bonxai.xsd.automaton.ParticleAutomatons.SubsetParticleAutomaton;
import de.tudortmund.cs.bonxai.xsd.automaton.ParticleAutomatons.ParticleBuilder;
...
import de.tudortmund.cs.bonxai.xsd.automaton.ParticleAutomatons.exceptions.NotSupportedParticleAutomatonException;
import java.util.*;
...
public class InterleaveHandler {
    ...
    private LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Group> allGroups = new LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Group>();
    ...
    private void repairGroups() throws EmptySubsetParticleStateFieldException, EmptyProductParticleStateFieldException, NotSupportedParticleAutomatonException {
        for (Iterator<de.tudortmund.cs.bonxai.xsd.Group> it = this.allGroups.iterator(); it.hasNext();) {
            de.tudortmund.cs.bonxai.xsd.Group group = it.next();
