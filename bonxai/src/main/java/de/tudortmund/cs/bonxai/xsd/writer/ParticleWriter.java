...
public abstract class ParticleWriter {
    ...
    protected static void writeParticle(Node root, Particle particle, FoundElements foundElements, Integer min, Integer max) {
        if (particle instanceof ElementRef) {
            ...
            writeElement(root, (de.tudortmund.cs.bonxai.xsd.Element) particle, foundElements, min, max);
     ...
     */
    protected static void writeElement(Node root, de.tudortmund.cs.bonxai.xsd.Element element, FoundElements foundElements) {
     ...
     * @param max
     */
    protected static void writeElement(Node root, de.tudortmund.cs.bonxai.xsd.Element element, FoundElements foundElements, Integer min, Integer max) {
        ...
        if (element.getFinalModifiers() != null && !element.getFinalModifiers().isEmpty()) {
            ...
            for (de.tudortmund.cs.bonxai.xsd.Element.Final currentFinalValue : element.getFinalModifiers()) {
        ...
        if (element.getBlockModifiers() != null && !element.getBlockModifiers().isEmpty()) {
            ...
            for (de.tudortmund.cs.bonxai.xsd.Element.Block currentBlockValue : element.getBlockModifiers()) {
    ...
    protected static void writeGroupRef(Node root, GroupRef groupRef, FoundElements foundElements, Integer min, Integer max) {
        ...
        de.tudortmund.cs.bonxai.xsd.Group group = (de.tudortmund.cs.bonxai.xsd.Group) groupRef.getGroup();
