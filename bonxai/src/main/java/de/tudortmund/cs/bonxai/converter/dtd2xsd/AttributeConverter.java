...
public class AttributeConverter extends ConverterBase {
     ...
     * @return de.tudortmund.cs.bonxai.xsd.Attribute        The resulting XSD attribute object
     * @throws Exception        Some different exceptions can be thrown in sub-methods of this method.
     */
    public de.tudortmund.cs.bonxai.xsd.Attribute convert(DocumentTypeDefinition dtd, Element dtdElement, Attribute dtdAttribute) throws Exception {
        ...
        de.tudortmund.cs.bonxai.xsd.Attribute attribute = null;
        ...
        attribute = new de.tudortmund.cs.bonxai.xsd.Attribute(attributeName, attributeTypeRef, defaultValue, fixedValue, attributeUse, false, this.qualification, annotation);
