...
public class SimpleContentRestriction extends Inheritance implements SimpleContentInheritance, SimpleTypeInheritance {
    ...
    public SimpleContentRestriction(de.tudortmund.cs.bonxai.common.SymbolTableRef<Type> base) {
        super(base);
        enumeration = new LinkedList<String>();
        this.attributes = new LinkedList<AttributeParticle>();
    }

    public SimpleContentRestriction(de.tudortmund.cs.bonxai.common.SymbolTableRef<Type> base, SimpleType anonymousSimpleType) {
        super(base);
        enumeration = new LinkedList<String>();
        this.attributes = new LinkedList<AttributeParticle>();
    ...
    public void setBase(SymbolTableRef<Type> base) {
        this.base = base;
    }
    ...
    public SimpleType getAnonymousSimpleType() {
        return anonymousSimpleType;
    }

    public void setAnonymousSimpleType(SimpleType anonymousSimpleType) {
        this.anonymousSimpleType = anonymousSimpleType;
    }
