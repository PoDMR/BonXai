...
public class SimpleContentUnion extends Inheritance implements SimpleTypeInheritance {
     ...
     */
    protected LinkedList<de.tudortmund.cs.bonxai.common.SymbolTableRef<Type>> memberTypes = new LinkedList<SymbolTableRef<Type>>();

    /**
     * Creates an instance with the given simpleTypes.
     * @param memberTypes
     */
    public SimpleContentUnion (LinkedList<de.tudortmund.cs.bonxai.common.SymbolTableRef<Type>> memberTypes) {
        super(null);
     ...
     */
    public LinkedList<de.tudortmund.cs.bonxai.common.SymbolTableRef<Type>> getAnonymousSimpleTypes () {
        LinkedList<de.tudortmund.cs.bonxai.common.SymbolTableRef<Type>> resultingTypes = new LinkedList<SymbolTableRef<Type>>();
     ...
     * @return HashSet<SimpleType>
     */
    public LinkedList<de.tudortmund.cs.bonxai.common.SymbolTableRef<Type>> getMemberTypes () {
        LinkedList<de.tudortmund.cs.bonxai.common.SymbolTableRef<Type>> resultingTypes = new LinkedList<SymbolTableRef<Type>>();
        for (Iterator<SymbolTableRef<Type>> it = memberTypes.iterator(); it.hasNext();) {
            SymbolTableRef<Type> symbolTableRef = it.next();
            if (symbolTableRef.getReference() instanceof SimpleType) {
     ...
     */
    public void addMemberType (de.tudortmund.cs.bonxai.common.SymbolTableRef<Type> val) {
