...
//                                        }
                    ...
                    if (complexType.getAttributes() != null && !complexType.getAttributes().isEmpty() && convertAttributes) {
                        for (Iterator<de.tudortmund.cs.bonxai.xsd.AttributeParticle> it = complexType.getAttributes().iterator(); it.hasNext();) {
                            de.tudortmund.cs.bonxai.xsd.AttributeParticle attributeParticle = it.next();
    ...
    private Pattern convertParticleToPattern(Particle particle, Integer level, LinkedHashMap<Integer, Integer> countingPatternMap) {
        ...
        if (particle instanceof ChoicePattern) {
            ...
            // Case "GroupRef":
            de.tudortmund.cs.bonxai.common.GroupRef groupRef = (de.tudortmund.cs.bonxai.common.GroupRef) particle;

            Pattern groupPattern = this.convertGroupToPattern((de.tudortmund.cs.bonxai.xsd.Group) groupRef.getGroup());
     ...
     */
    public Pattern convertGroupToPattern(de.tudortmund.cs.bonxai.xsd.Group xsdGroup) {
        Pattern returnPattern = null;
     ...
     */
    public Pattern handleSubstitutions(de.tudortmund.cs.bonxai.xsd.Element xsdElement, Pattern pattern, boolean convertAttributes) {
        /**
        ...
        if (XSD2RelaxNGConverter.HANDLE_SUBSTITUTIONS && this.typeInheritanceInformation.containsKey(xsdElement.getType())) {
            ...
            LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Type> typeSubstitutions = informationCollector.getAllTypeSubstitutionsForElement(xsdElement, this.typeInheritanceInformation);

            if (!typeSubstitutions.isEmpty()) {

                Choice choice = new Choice();
                choice.addPattern(pattern);
                for (Iterator<de.tudortmund.cs.bonxai.xsd.Type> it = typeSubstitutions.iterator(); it.hasNext();) {
                    de.tudortmund.cs.bonxai.xsd.Type xsdSubstitutionType = it.next();
    ...
    private LinkedHashMap<String, AttributeParticle> getAttributeMapFromAttributeParticleList(LinkedList<AttributeParticle> attributes) {
        ...
        for (Iterator<AttributeParticle> it = attributes.iterator(); it.hasNext();) {
            ...
            for (Iterator<AttributeParticle> it1 = attributeSet.iterator(); it1.hasNext();) {
                ...
                if (attributeParticle1 instanceof de.tudortmund.cs.bonxai.xsd.Attribute) {
                    de.tudortmund.cs.bonxai.xsd.Attribute attribute = (de.tudortmund.cs.bonxai.xsd.Attribute) attributeParticle1;
                    resultMap.put(attribute.getName(), attribute);
                } else if (attributeParticle1 instanceof de.tudortmund.cs.bonxai.common.AnyAttribute) {
                    de.tudortmund.cs.bonxai.common.AnyAttribute anyAttribute = (AnyAttribute) attributeParticle1;
    ...
    private LinkedHashMap<String, AttributeParticle> mergeAttributeMaps(LinkedHashMap<String, AttributeParticle> baseMap, LinkedHashMap<String, AttributeParticle> overwritingMap) {
        ...
        for (Iterator<String> it = overwritingMap.keySet().iterator(); it.hasNext();) {
            ...
            if (overwritingMap.get(key) instanceof de.tudortmund.cs.bonxai.xsd.Attribute) {
                de.tudortmund.cs.bonxai.xsd.Attribute attribute = (de.tudortmund.cs.bonxai.xsd.Attribute) overwritingMap.get(key);
                resultMap.put(attribute.getName(), attribute);
            } else if (overwritingMap.get(key) instanceof de.tudortmund.cs.bonxai.common.AnyAttribute) {
                de.tudortmund.cs.bonxai.common.AnyAttribute anyAttribute = (AnyAttribute) overwritingMap.get(key);
                resultMap.put("anyAttribute", anyAttribute);
            }
        }
        ...
        for (Iterator<String> it = baseMap.keySet().iterator(); it.hasNext();) {
            ...
            if (!resultMap.containsKey(key)) {
                if (baseMap.get(key) instanceof de.tudortmund.cs.bonxai.xsd.Attribute) {
                    de.tudortmund.cs.bonxai.xsd.Attribute attribute = (de.tudortmund.cs.bonxai.xsd.Attribute) baseMap.get(key);
                    resultMap.put(attribute.getName(), attribute);
                } else if (baseMap.get(key) instanceof de.tudortmund.cs.bonxai.common.AnyAttribute) {
                    de.tudortmund.cs.bonxai.common.AnyAttribute anyAttribute = (AnyAttribute) baseMap.get(key);
                    resultMap.put("anyAttribute", anyAttribute);
                }
            }
        }
    ...
    private LinkedHashSet<AttributeParticle> collectAttributesFromAttributeParticle(AttributeParticle attributeParticle) {
        ...
        if (attributeParticle instanceof de.tudortmund.cs.bonxai.xsd.Attribute || attributeParticle instanceof de.tudortmund.cs.bonxai.common.AnyAttribute) {
            ...
            // Case "attributeGroup":
            de.tudortmund.cs.bonxai.xsd.AttributeGroup attributeGroup = (de.tudortmund.cs.bonxai.xsd.AttributeGroup) attributeParticle;
            ...
            de.tudortmund.cs.bonxai.xsd.AttributeGroupRef attributeGroupRef = (de.tudortmund.cs.bonxai.xsd.AttributeGroupRef) attributeParticle;
            ...
            // Case "attribute ref":
            de.tudortmund.cs.bonxai.xsd.AttributeRef attributeRef = (de.tudortmund.cs.bonxai.xsd.AttributeRef) attributeParticle;
