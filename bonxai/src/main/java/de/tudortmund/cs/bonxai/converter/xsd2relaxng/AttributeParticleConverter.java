...
public class AttributeParticleConverter extends ConverterBase {
    ...
    public Pattern convert(AttributeParticle attributeParticle) {
        ...
        if (attributeParticle instanceof de.tudortmund.cs.bonxai.xsd.Attribute) {
            ...
            de.tudortmund.cs.bonxai.xsd.Attribute xsdAttribute = (de.tudortmund.cs.bonxai.xsd.Attribute) attributeParticle;
            ...
            de.tudortmund.cs.bonxai.common.AnyAttribute anyAttribute = (AnyAttribute) attributeParticle;
