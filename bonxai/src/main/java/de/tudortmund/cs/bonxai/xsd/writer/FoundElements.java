...
class FoundElements {
    ...
    private LinkedList<de.tudortmund.cs.bonxai.xsd.Element> elements;
    private LinkedList<AttributeGroup> attributeGroups;
    private LinkedList<de.tudortmund.cs.bonxai.common.Group> groups;
    ...
    protected FoundElements()
    {
        ...
        elements = new LinkedList<de.tudortmund.cs.bonxai.xsd.Element>();
        attributeGroups = new LinkedList<AttributeGroup>();
        groups = new LinkedList<de.tudortmund.cs.bonxai.common.Group>();
    ...
    public void addElement(de.tudortmund.cs.bonxai.xsd.Element e)
    {
        elements.add(e);
    }
    ...
    public void addGroup(de.tudortmund.cs.bonxai.common.Group g)
    {
        groups.add(g);
    }
     ...
     * @return
     */
    public boolean containsElement(de.tudortmund.cs.bonxai.xsd.Element e)
    {
     ...
     * @return
     */
    public boolean containsGroup(de.tudortmund.cs.bonxai.common.Group g)
    {
