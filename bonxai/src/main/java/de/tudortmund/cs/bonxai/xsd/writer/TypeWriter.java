...
//        if (foundElements.containsType(baseType) && root.getNodeName().contains("element")) {
    ...
    protected static void writeSimpContUnion(Node sTypeNode, SimpleContentUnion contentUnion, FoundElements foundElements) {
        ...
        LinkedList<de.tudortmund.cs.bonxai.common.SymbolTableRef<Type>> types;
        LinkedList<de.tudortmund.cs.bonxai.common.SymbolTableRef<Type>> memberTypes;
        ...
        for (de.tudortmund.cs.bonxai.common.SymbolTableRef<Type> t : types) {
            writeSimpleType(unionElement, (SimpleType) t.getReference(), foundElements, false);
        }
        for (de.tudortmund.cs.bonxai.common.SymbolTableRef<Type> currentMemberType : memberTypes) {
