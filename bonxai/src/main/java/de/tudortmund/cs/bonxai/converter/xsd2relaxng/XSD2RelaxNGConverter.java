 ...
 * XSD object model (de.tudortmund.cs.bonxai.xsd) to the
 * RELAX NG object model (de.tudortmund.cs.bonxai.dtd).
 *
...
public class XSD2RelaxNGConverter extends ConverterBase {
    ...
    public RelaxNGSchema convert() throws ConversionFailedException {
    	try {
    		 ...
    		 */
    		LinkedHashMap<de.tudortmund.cs.bonxai.xsd.Element, LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Element>> elementInheritanceInformation = null;
    		if (HANDLE_SUBSTITUTIONS) {
    			...
    			elementInheritanceInformation = new LinkedHashMap<de.tudortmund.cs.bonxai.xsd.Element, LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Element>>();
    		}
    		/**
    		 * 4.
     ...
     */
    private void findNotUsedComponents(XSDSchema xmlSchema, LinkedHashSet<XSDSchema> alreadySeenSchemas, LinkedHashSet<Type> foundTypes, LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Attribute> foundAttributes, LinkedHashSet<de.tudortmund.cs.bonxai.xsd.AttributeGroup> foundAttributeGroups, LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Group> foundGroups) {
     ...
     */
    private void generateDefinesForNotUsedComponents(LinkedHashMap<Type, LinkedHashSet<Type>> typeInheritanceInformation, LinkedHashMap<de.tudortmund.cs.bonxai.xsd.Element, LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Element>> elementInheritanceInformation) {

        // Provide sets for each type of a possible unused schema component
        LinkedHashSet<Type> foundTypes = new LinkedHashSet<Type>();
        LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Attribute> foundAttributes = new LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Attribute>();
        LinkedHashSet<de.tudortmund.cs.bonxai.xsd.AttributeGroup> foundAttributeGroups = new LinkedHashSet<AttributeGroup>();
        LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Group> foundGroups = new LinkedHashSet<de.tudortmund.cs.bonxai.xsd.Group>();
        ...
        if (!foundAttributes.isEmpty()) {
            ...
            for (Iterator<de.tudortmund.cs.bonxai.xsd.Attribute> it = foundAttributes.iterator(); it.hasNext();) {
                de.tudortmund.cs.bonxai.xsd.Attribute attribute = it.next();
        ...
        if (!foundAttributeGroups.isEmpty()) {
            ...
            for (Iterator<de.tudortmund.cs.bonxai.xsd.AttributeGroup> it = foundAttributeGroups.iterator(); it.hasNext();) {
                de.tudortmund.cs.bonxai.xsd.AttributeGroup attributeGroup = it.next();
        ...
        if (!foundGroups.isEmpty()) {
            ...
            // Handle found groups
            for (Iterator<de.tudortmund.cs.bonxai.xsd.Group> it = foundGroups.iterator(); it.hasNext();) {
                de.tudortmund.cs.bonxai.xsd.Group group = it.next();
        ...
        if (!foundTypes.isEmpty()) {
            ...
            // Handle found types
            for (Iterator<de.tudortmund.cs.bonxai.xsd.Type> it = foundTypes.iterator(); it.hasNext();) {
