...
abstract class ConstraintVisitor {
    ...
    public void visitSchema( XSDSchema schema ) {
        ...
        for( de.tudortmund.cs.bonxai.xsd.Element element: schema.getElements() ) {
     ...
     */
    protected void visitElement( de.tudortmund.cs.bonxai.xsd.Element element ) {
    ...
    protected void visitParticle( Particle particle ) {
        if ( particle instanceof de.tudortmund.cs.bonxai.xsd.Element ) {
            this.visitElement( (de.tudortmund.cs.bonxai.xsd.Element)particle );
        }
