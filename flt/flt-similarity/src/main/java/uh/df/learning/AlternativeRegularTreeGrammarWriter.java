 ...
 * 
 */
public class AlternativeRegularTreeGrammarWriter implements GrammarWriter {
	...
	public void write(XMLGrammar doc, Properties properties, Writer writer) throws IOException {
		if (properties != null) {
	...
	protected void computeRules(XMLGrammar doc, XMLElementDefinition element, Map<String, String> ruleMap)
			throws IOException {
		String elementName = XMLGrammar.computeElementName(element.getQName(), element.getType());
