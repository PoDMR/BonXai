...
public class CollectionsTest extends TestCase {
    ...
    public void test_takeOne() throws Exception {
        ...
        for (int i = set.size(); i > 0; i--) {
            ...
            String s = gjb.util.Collections.takeOne(set);
            assertTrue(s.equals("a") || s.equals("b") || s.equals("c"));
        }
        assertTrue("empty", set.isEmpty());
        assertEquals("null value", null, gjb.util.Collections.takeOne(set));
    ...
    public void test_intersection() throws Exception {
        ...
        set2.add("c");
        set2.add("d");
        Set<String> intersection1 = gjb.util.Collections.intersect(set1, set2);
        ...
        Set<String> intersection2 = gjb.util.Collections.intersect(set2, set1);
        ...
        set2.add("d");
        set2.add("e");
        Set<String> intersection3 = gjb.util.Collections.intersect(set1, set2);
        assertTrue("size", intersection3.isEmpty());
        set2 = new HashSet<String>();
        Set<String> intersection4 = gjb.util.Collections.intersect(set1, set2);
        assertTrue("size", intersection4.isEmpty());
        Set<String> intersection5 = gjb.util.Collections.intersect(set2, set1);
