...
import eu.fox7.flt.treegrammar.MaxDepthExceededException;
...
public class XMLDocumentTest extends TestCase {
	...
	public void testUserObjectGeneration() {
        try {
	        String userObjectShortStr =
	            "generator: short = eu.fox7.flt.treegrammar.data.StringGenerator(min = 1, max = 3)";
	        String userObjectLongStr =
	            "generator: long = eu.fox7.flt.treegrammar.data.StringGenerator(min = 15, max = 18)";
	...
	public void testParseGrammarUserObjects() {
        String userObjects =
            ...
            "generator: CDATA = eu.fox7.flt.treegrammar.data.StringGenerator()\n" +
