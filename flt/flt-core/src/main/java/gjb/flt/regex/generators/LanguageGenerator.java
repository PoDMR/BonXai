 ...
 */
package gjb.flt.regex.generators;
...
public class LanguageGenerator {
	...
	protected gjb.flt.automata.generators.LanguageGenerator languageGenerator;
	protected Tree tree;
    ...
    public Iterator<List<String>> generatingRun(int length) {
    	if (languageGenerator == null)
    		languageGenerator = new gjb.flt.automata.generators.LanguageGenerator(nfa);
