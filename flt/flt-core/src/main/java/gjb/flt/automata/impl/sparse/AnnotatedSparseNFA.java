...
public class AnnotatedSparseNFA<StateT,TransitionT> extends SparseNFA
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.ModifiableAnnotatedNFA#annotate(java.lang.String, StateT)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.ModifiableAnnotatedNFA#annotate(gjb.flt.automata.State, StateT)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#getAnnotation(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#getAnnotation(gjb.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#hasAnnotation(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#hasAnnotation(gjb.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.ModifiableAnnotatedNFA#annotate(gjb.flt.automata.Transition, TransitionT)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.ModifiableAnnotatedNFA#annotate(gjb.flt.automata.Symbol, gjb.flt.automata.State, gjb.flt.automata.State, TransitionT)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.ModifiableAnnotatedNFA#annotate(java.lang.String, java.lang.String, java.lang.String, TransitionT)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#getAnnotation(gjb.flt.automata.Transition)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#getAnnotation(gjb.flt.automata.Symbol, gjb.flt.automata.State, gjb.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#getAnnotation(java.lang.String, java.lang.String, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#hasAnnotation(gjb.flt.automata.Transition)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#hasAnnotation(gjb.flt.automata.Symbol, gjb.flt.automata.State, gjb.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see gjb.flt.automata.AnnotatedNFA#hasAnnotation(java.lang.String, java.lang.String, java.lang.String)
     */
