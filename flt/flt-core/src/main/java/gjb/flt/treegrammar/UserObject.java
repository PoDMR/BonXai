 ...
 * or
 * <pre>
 * generator: CDATA = gjb.xml.model.StringGenerator(min = 3, max = 30)
 * </pre>
 * The probabilities used in the example shown in gjb.xml.model.XMLDocument can
 * be defined as:
 * <pre>
 * distribution: skewed = gjb.math.UserDefinedDistribution(0 = 0.1, 1 = 0.9)
 * generator: CDATA = gjb.xml.model.StringGenerator()
 * generator: PCDATA = gjb.xml.model.StringGenerator(max = 30)
 ...
 * implement the gjb.xml.model.DataGenerator and 
 * gjb.math.ProbabilityDistribution respectively. </p>
 * @author gjb
