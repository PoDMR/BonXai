...
import eu.fox7.flt.automata.DFA;
...
public class SparseNFA implements DFA, StateDFA, ModifiableStateNFA, ModifiableStateDFA {
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#add(eu.fox7.flt.automata.SparseNFA)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#alphabet()
     */
    @Deprecated
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#numberOfSymbols()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#hasSymbol(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#hasSymbol(eu.fox7.flt.automata.Symbol)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#removeSymbol(eu.fox7.flt.automata.Symbol)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#states()
     */
    @Deprecated
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#numberOfStates()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#state(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#stateValue(eu.fox7.flt.automata.State)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#hasState(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#hasState(eu.fox7.flt.automata.State)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#addState(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#addState(eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#addState(java.lang.String, eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#removeState(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#removeState(eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#transitions()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#numberOfTransitions()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#setTransitionMap(eu.fox7.flt.automata.TransitionMap)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#hasTransition(java.lang.String, java.lang.String, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#addTransition(java.lang.String, java.lang.String, java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#addTransition(eu.fox7.flt.automata.Symbol, eu.fox7.flt.automata.State, eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#removeTransition(java.lang.String, java.lang.String, java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#removeTransition(eu.fox7.flt.automata.Symbol, eu.fox7.flt.automata.State, eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#nextStateValues(java.lang.String, java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#numberOfChoicesFrom(eu.fox7.flt.automata.State)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#setInitialState(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#setInitialState(eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#isInitialState(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#isInitialState(eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#initialState()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#clearInitialState()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#finalStates()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#numberOfFinalStates()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#hasFinalStates()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#isFinalState(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#isFinalState(eu.fox7.flt.automata.State)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#setFinalState(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#setFinalState(eu.fox7.flt.automata.State)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#addFinalState(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#addFinalState(eu.fox7.flt.automata.State)
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#clearFinalStates()
     */
	...
	/* (non-Javadoc)
     * @see eu.fox7.flt.automata.ModifiableNFA#clearFinalState(eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#isSinkState(eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#isSourceState(eu.fox7.flt.automata.State)
     */
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#reachableStates()
     */
    public Set<State> reachableStates() {
        ...
        while (!toDo.isEmpty()) {
            State state = eu.fox7.util.Collections.takeOne(toDo);
    ...
    /* (non-Javadoc)
     * @see eu.fox7.flt.automata.NFA#terminatingStates()
     */
