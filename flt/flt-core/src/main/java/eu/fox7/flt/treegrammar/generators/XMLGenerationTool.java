 ...
 */
package eu.fox7.flt.treegrammar.generators;
...
public class XMLGenerationTool {
    ...
    protected static void printHelp(Options options) {
		...
		formatter.printHelp("java eu.fox7.xml.model.XMLGenerator -g grammar-file [-u user-objects-file] [-o output] [-n number] [-m max-tries] [-h]",
							options);
	}
