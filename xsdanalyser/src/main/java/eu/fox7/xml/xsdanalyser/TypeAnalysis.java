...
public class TypeAnalysis {
    ...
    public TypeAnalysis(XSDSchema xsd) {
        super();
    ...
    public boolean foundTrueSingleTypeDefs() {
        for (Iterator<String> elementNameIt = getElementNameIterator();
             elementNameIt.hasNext(); ) {
    ...
    protected static class Occurrence {
        ...
        protected Occurrence(String name, String context,
