...
import eu.fox7.schematoolkit.converter.relaxng2xsd.PatternSimpleTypeConverter;
...
public class PatternSimpleTypeConverterTest extends junit.framework.TestCase {
    ...
    private void writeToSystemOut(SimpleType simpleType) {
        eu.fox7.schematoolkit.xsd.om.Element dummyElement = new eu.fox7.schematoolkit.xsd.om.Element("{}dummy", this.schema.getTypeSymbolTable().updateOrCreateReference(simpleType.getName(), simpleType));
