...
import eu.fox7.schematoolkit.converter.relaxng2xsd.PatternElementConverter;
...
import eu.fox7.schematoolkit.converter.relaxng2xsd.exceptions.NoCombineMethodException;
import eu.fox7.schematoolkit.converter.relaxng2xsd.exceptions.TooManyDataOrValuePatternsUnderAnElementException;
...
//        System.out.println(xsd_Writer.getXSDString());
    ...
    public void testConvert_01_findRootElements_with_element() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_01.rng");
        ...
        eu.fox7.schematoolkit.xsd.om.Element element = this.schema.getElements().getFirst();
    ...
    public void testConvert_02_findRootElements_with_choice() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_02.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(2, this.schema.getElements().size());
        eu.fox7.schematoolkit.xsd.om.Element element = this.schema.getElements().getFirst();
        assertEquals("{}a", element.getName());
        eu.fox7.schematoolkit.xsd.om.Element element2 = this.schema.getElements().getLast();
    ...
    public void testConvert_03_findRootElements_with_grammar_ref_parentRef() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_03.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        eu.fox7.schematoolkit.xsd.om.Element element = this.schema.getElements().getFirst();
    ...
    public void testConvert_04_convertElement_nameAttribute() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_04.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        eu.fox7.schematoolkit.xsd.om.Element element = this.schema.getElements().getFirst();
    ...
    public void testConvert_05_convertElement_nameClass() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_05.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        eu.fox7.schematoolkit.xsd.om.Element element = this.schema.getElements().getFirst();
    ...
    public void testConvert_06_convertElement_nameClassAny() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_06.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
    ...
    public void testConvert_07_convertElement_inner_nameClassAny() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_07.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        eu.fox7.schematoolkit.xsd.om.Element element = this.schema.getElements().getFirst();
        ...
        assertTrue(sequencePattern.getParticles().getFirst() instanceof eu.fox7.schematoolkit.common.AnyPattern);

        eu.fox7.schematoolkit.common.AnyPattern anyPattern = (eu.fox7.schematoolkit.common.AnyPattern) sequencePattern.getParticles().getFirst();
    ...
    public void testConvert_08_convertElement_externalNamespace() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_08.rng");
        ...
        SequencePattern sequencePattern = (SequencePattern) complexContentType.getParticle();
        assertEquals(1, sequencePattern.getParticles().size());
        assertTrue(sequencePattern.getParticles().getFirst() instanceof eu.fox7.schematoolkit.common.ElementRef);

        eu.fox7.schematoolkit.common.ElementRef elementRef = (eu.fox7.schematoolkit.common.ElementRef) sequencePattern.getParticles().getFirst();
    ...
    public void testConvert_09_generateTypeForElement_notAllowed() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_09.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(0, this.schema.getElements().size());
    }
    ...
    public void testConvert_10_generateTypeForElement_only_text() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_10.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        eu.fox7.schematoolkit.xsd.om.Element element = this.schema.getElements().getFirst();
    ...
    public void testConvert_11_generateTypeForElement_only_empty() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_11.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_12_generateTypeForElement_only_simpleTypeContent() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_12.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_13_generateTypeForElement_attributeAndSimpleTypeContent() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_13.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        ...
        eu.fox7.schematoolkit.xsd.om.Attribute attribute = (eu.fox7.schematoolkit.xsd.om.Attribute) simpleContentExtension.getAttributes().getFirst();
    ...
    public void testConvert_14_generateTypeForElement_onlyAnAttribute() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_14.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        ...
        eu.fox7.schematoolkit.xsd.om.Attribute attribute = (eu.fox7.schematoolkit.xsd.om.Attribute) complexType.getAttributes().getFirst();
        assertEquals("{}bob", attribute.getName());
    }
    ...
    public void testConvert_15_generateTypeForElement_onlyElement() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_15.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        ...
        SequencePattern sequencePattern = (SequencePattern) complexContentType.getParticle();
        assertEquals(1, sequencePattern.getParticles().size());
        assertTrue(sequencePattern.getParticles().getFirst() instanceof eu.fox7.schematoolkit.xsd.om.Element);

        eu.fox7.schematoolkit.xsd.om.Element element1 = (eu.fox7.schematoolkit.xsd.om.Element) sequencePattern.getParticles().getFirst();
    ...
    public void testConvert_16_generateTypeForElement_ElementAndAttribute() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_16.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_17_generateTypeForElement_ElementAndAttributeAndMixed() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_17.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_18_generateTypeForElement_ElementInType() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_18.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        ...
        eu.fox7.schematoolkit.xsd.om.Element element2 = (eu.fox7.schematoolkit.xsd.om.Element) sequencePattern.getParticles().getLast();
    ...
    public void testConvert_19_generateTypeForElement_ElementInTypeAndAttribute() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_19.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        ...
        eu.fox7.schematoolkit.xsd.om.Attribute attribute = (eu.fox7.schematoolkit.xsd.om.Attribute) complexContentExtension.getAttributes().getFirst();
        assertEquals("{}blub", attribute.getName());
    }
    ...
    public void testConvert_20_generateTypeForElement_ElementInTypeAndAttribute() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_20.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_21_generateTypeForElement_ElementInTypeAndAttribute() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_21.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        ...
        assertTrue(complexContentType.getMixed());
        assertEquals(null, complexContentType.getInheritance());
        assertTrue(complexContentType.getParticle() instanceof eu.fox7.bonxai.common.GroupRef);

        eu.fox7.bonxai.common.GroupRef groupRef = (eu.fox7.bonxai.common.GroupRef) complexContentType.getParticle();
    ...
    public void testConvert_22_generateTypeForElement_NoElementsNoAttributesNoSimpleType() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_22.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
    ...
    public void testConvert_23_generateTypeForElement_with_TooManyDataOrValuePatternsUnderAnElementException() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_23.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        try {
            instance.convert();
    ...
    public void testConvert_24_convertPatternToElementParticleStructure_ZeroOrMore() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_24.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        ...
        SequencePattern sequencePattern = (SequencePattern) complexContentType.getParticle();
        assertEquals(1, sequencePattern.getParticles().size());
        assertTrue(sequencePattern.getParticles().getFirst() instanceof eu.fox7.schematoolkit.common.CountingPattern);
        eu.fox7.schematoolkit.common.CountingPattern countingPattern = (CountingPattern) sequencePattern.getParticles().getFirst();

        assertEquals("0", countingPattern.getMin().toString());
        assertEquals(null, countingPattern.getMax());

        assertTrue(countingPattern.getParticles().getFirst() instanceof eu.fox7.schematoolkit.xsd.om.Element);

        eu.fox7.schematoolkit.xsd.om.Element element1 = (eu.fox7.schematoolkit.xsd.om.Element) countingPattern.getParticles().getFirst();
        assertEquals("{}bob", element1.getName());
    }
    ...
    public void testConvert_25_convertPatternToElementParticleStructure_Group() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_25.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_26_convertPatternToElementParticleStructure_OneOrMore() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_26.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_27_convertPatternToElementParticleStructure_Optional() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_27.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_28_convertPatternToElementParticleStructure_Choice() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_28.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        ...
        assertFalse(complexContentType.getMixed());
        assertEquals(null, complexContentType.getInheritance());
        assertTrue(complexContentType.getParticle() instanceof eu.fox7.schematoolkit.common.ChoicePattern);
        eu.fox7.schematoolkit.common.ChoicePattern choicePattern = (eu.fox7.schematoolkit.common.ChoicePattern) complexContentType.getParticle();

        assertTrue(choicePattern.getParticles().getFirst() instanceof eu.fox7.schematoolkit.xsd.om.Element);

        eu.fox7.schematoolkit.xsd.om.Element element1 = (eu.fox7.schematoolkit.xsd.om.Element) choicePattern.getParticles().getFirst();
        assertEquals("{}bob", element1.getName());
    }
    ...
    public void testConvert_29_convertPatternToElementParticleStructure_Interleave() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_29.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
        ...
        assertFalse(complexContentType.getMixed());
        assertEquals(null, complexContentType.getInheritance());
        assertTrue(complexContentType.getParticle() instanceof eu.fox7.schematoolkit.common.AllPattern);
        eu.fox7.schematoolkit.common.AllPattern allPattern = (eu.fox7.schematoolkit.common.AllPattern) complexContentType.getParticle();

        assertTrue(allPattern.getParticles().getFirst() instanceof eu.fox7.schematoolkit.xsd.om.Element);

        eu.fox7.schematoolkit.xsd.om.Element element1 = (eu.fox7.schematoolkit.xsd.om.Element) allPattern.getParticles().getFirst();
        assertEquals("{}bob", element1.getName());
    }
    ...
    public void testConvert_30_convertPatternToElementParticleStructure_Grammar_parentRef_ref() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_30.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_31_convertPatternToElementParticleStructure_with_NoCombineMethodException() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_31.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
    ...
    public void testConvert_32_findRecursiveElementsInGrammar_with_ZeroOrMore() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_32.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
    ...
    public void testConvert_33_findRecursiveElementsInGrammar_with_Group() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_33.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        HashSet<Element> recursiveElements = instance.getRecursiveElements();
    ...
    public void testConvert_34_findRecursiveElementsInGrammar_with_OneOrMore() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_34.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        HashSet<Element> recursiveElements = instance.getRecursiveElements();
    ...
    public void testConvert_35_findRecursiveElementsInGrammar_with_Optional() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_35.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        HashSet<Element> recursiveElements = instance.getRecursiveElements();
    ...
    public void testConvert_36_findRecursiveElementsInGrammar_with_Choice() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_36.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        HashSet<Element> recursiveElements = instance.getRecursiveElements();
    ...
    public void testConvert_37_findRecursiveElementsInGrammar_with_Interleave() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_37.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        HashSet<Element> recursiveElements = instance.getRecursiveElements();
    ...
    public void testConvert_38_findRecursiveElementsInGrammar_with_Mixed() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_38.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        HashSet<Element> recursiveElements = instance.getRecursiveElements();
    ...
    public void testConvert_39_findRecursiveElementsInGrammar_with_GrammarAndParentRefAndRef() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_39.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        HashSet<Element> recursiveElements = instance.getRecursiveElements();
    ...
    public void testConvert_40_checkPatternListForRefForComplexType_Choice() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_40.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_41_checkPatternListForRefForComplexType_Group() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_41.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
    ...
    public void testConvert_42_checkPatternListForRefForComplexType_Interleave() throws Exception {
        parseAndPrepareRNG("tests/eu/fox7/bonxai/converter/relaxng2xsd/PatternElementConverterTest/element_42.rng");
        PatternElementConverter instance = new PatternElementConverter(schema, rng, this.patternInformationCollector.getPatternIntel(), new HashSet<String>(), new HashSet<String>());
        instance.convert();
        assertEquals(1, this.schema.getElements().size());
