...
public class AttributeParticleConverter extends ConverterBase {
    ...
    public Pattern convert(AttributeParticle attributeParticle) {
        ...
        if (attributeParticle instanceof eu.fox7.schematoolkit.xsd.om.Attribute) {
            ...
            eu.fox7.schematoolkit.xsd.om.Attribute xsdAttribute = (eu.fox7.schematoolkit.xsd.om.Attribute) attributeParticle;
            ...
            eu.fox7.schematoolkit.common.AnyAttribute anyAttribute = (AnyAttribute) attributeParticle;
