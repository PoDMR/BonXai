 ...
 * "BlockFinalSpreadingHandler" in package "eu.fox7.schematoolkit.xsd.om.tools".
 *
 * @author Lars Schmidt
 */
public class SubstitutionGroupInformationCollector {
    ...
    private HashMap<SymbolTableRef<eu.fox7.schematoolkit.xsd.om.Element>, HashSet<SymbolTableRef<eu.fox7.schematoolkit.xsd.om.Element>>> substitutionElements = new HashMap<SymbolTableRef<Element>, HashSet<SymbolTableRef<Element>>>();
    ...
    private void collectBaseInformation(XSDSchema xmlSchema) {
        ...
        HashMap<SymbolTableRef<eu.fox7.schematoolkit.xsd.om.Element>, HashSet<SymbolTableRef<eu.fox7.schematoolkit.xsd.om.Element>>> currentSubstitutionElementsMap = xmlSchema.getSubstitutionElements();
        for (Iterator<SymbolTableRef<eu.fox7.schematoolkit.xsd.om.Element>> it = currentSubstitutionElementsMap.keySet().iterator(); it.hasNext();) {
            SymbolTableRef<eu.fox7.schematoolkit.xsd.om.Element> stRefElementHead = it.next();

            if (substitutionElements.containsKey(stRefElementHead)) {
                HashSet<SymbolTableRef<eu.fox7.schematoolkit.xsd.om.Element>> targetSet = substitutionElements.get(stRefElementHead);
        ...
        for (Iterator<SymbolTableRef<eu.fox7.schematoolkit.xsd.om.Element>> it = substitutionElements.keySet().iterator(); it.hasNext();) {
            SymbolTableRef<eu.fox7.schematoolkit.xsd.om.Element> stRefElementHead = it.next();
