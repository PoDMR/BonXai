  ...
  final public void Decl() throws ParseException {
    ...
    try {
      ...
      case NAMESPACE:
        ...
        break;
      case TARGET_NAMESPACE:
        jj_consume_token(TARGET_NAMESPACE);
        uri = NamespaceUriLiteral();
...
//UniqueConstraint    ::= "unique" APattern "=" "{" ConstraintSelector ConstraintFields "}"
  final public void UniqueConstraint() throws ParseException {
    ...
    try {
                          AncestorPattern aPattern=null; AncestorPattern selector; List<AncestorPattern> fields;
...
// KeyConstraint       ::= "key" Name APattern "{" ConstraintSelector ConstraintFields "}"
  final public void KeyConstraint() throws ParseException {
    ...
    try {
                       QualifiedName name; AncestorPattern aPattern=null; AncestorPattern selector; List<AncestorPattern> fields;
...
// Expr                ::= Annotations? APattern "=" CPattern
  final public void Expr() throws ParseException {
    trace_call("Expr");
    try {
              startOfAPattern=true; AncestorPattern aPattern; ChildPattern cPattern; List<Annotation> annotations=new LinkedList<Annotation>();
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case PERCENT:
...
// ignoring simple aPatterns for now!
  ...
  final public AncestorPattern SimpleAPatternX() throws ParseException {
    trace_call("SimpleAPatternX");
    try {
...
// CPattern            ::= "{" ( AttributePattern "," )? ElementPattern "}"
  final public ChildPattern CPattern() throws ParseException {
    trace_call("CPattern");
    try {
                           boolean mixed = false; boolean nillable = false; AttributePattern attributePattern = null; ElementPattern elementPattern = new ElementPattern(new EmptyPattern());
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case MIXED:
      ...
      jj_consume_token(CLOSING_CURLY_BRACKET);
      {if (true) return new ChildPattern(attributePattern, elementPattern, mixed, nillable);}
    throw new Error("Missing return statement in function");
    } finally {
...
//                      | "missing"? MixedRegex
  final public ElementPattern ElementPattern() throws ParseException {
    ...
    try {
                                  boolean empty=false; Particle particle=null; BonxaiType type=null;
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case EMPTY:
      ...
      default:
        ...
        throw new ParseException();
                ...
                if (particle!=null) {
                        {if (true) return new ElementPattern(particle);}
        } else {
                        {if (true) return new ElementPattern(type);}
        }
    throw new Error("Missing return statement in function");
    } finally {
...
//TODO: foreign
  final public Particle NamedType() throws ParseException {
    ...
    try {
                       Token t; BonxaiType type; Particle p; QualifiedName name; List<Namespace> namespaceList=new LinkedList<Namespace>(); List<QualifiedName> nameList=new LinkedList<QualifiedName>(); boolean complement = false; ProcessContentsInstruction policy = ProcessContentsInstruction.STRICT;
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ELEMENT:
      ...
      case ANY:
        ...
        jj_consume_token(CLOSING_CURLY_BRACKET);
                                                                                                                                                                                               p = new AnyPattern(policy, complement, namespaceList, nameList);
        break;
      default:
        jj_la1[51] = jj_gen;
        jj_consume_token(-1);
...
//NamespaceList       ::= "not"? "{" (NamespaceURI | ##other | ##local | ##targetNamespace)* "}"
  final public List<Namespace> NamespaceList() throws ParseException {
    trace_call("NamespaceList");
    try {
                                   List<Namespace> namespaceList = new LinkedList<Namespace>();
      jj_consume_token(OPENING_CURLY_BRACKET);
      jj_consume_token(CLOSING_CURLY_BRACKET);
    {if (true) return namespaceList;}
    throw new Error("Missing return statement in function");
    } finally {
...
//NameList            ::= "name" "not" "{" Name* "}"
  final public List<QualifiedName> NameList() throws ParseException {
    trace_call("NameList");
    try {
                                  List<QualifiedName> nameList = new LinkedList<QualifiedName>(); QualifiedName name;
      jj_consume_token(NAMEX);
      jj_consume_token(NOT);
      jj_consume_token(OPENING_CURLY_BRACKET);
      label_16:
      while (true) {
    ...
    try {
      ...
      default:
        ...
        ;
          ...
          setState(DEFAULT); {if (true) return new Attribute(name, type, required);}
    throw new Error("Missing return statement in function");
    } finally {
...
// Policy             ::= "strict" | "lax" | "skip"
  final public ProcessContentsInstruction Policy() throws ParseException {
    trace_call("Policy");
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case STRICT:
        jj_consume_token(STRICT);
                    {if (true) return ProcessContentsInstruction.STRICT;}
        break;
      case LAX:
        jj_consume_token(LAX);
                                                                        {if (true) return ProcessContentsInstruction.LAX;}
        break;
      case SKIPP:
        jj_consume_token(SKIPP);
                                                                                                                           {if (true) return ProcessContentsInstruction.SKIP;}
        break;
      default:
        jj_la1[60] = jj_gen;
        jj_consume_token(-1);
...
// Number              ::= Digit+
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x600,0x80000,0x8000,0x600,0x0,0x0,0x0,0x70000,0x70000,0x0,0x0,0x0,0x0,0x300000,0x300000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000000,0x1000000,0x4000000,0x1000000,0x0,0x1af00800,0x18100800,0x1a100800,0x0,0x0,0x0,0x0,0x0,0x18100000,0x0,0x0,0x0,0x0,0x0,0xe0000000,0x0,0x0,0x0,0x18100000,0x0,0xe00000,0xe00000,0x1000,0x0,0x0,0x0,0x0,0xe0000000,0x1000,0x1000,0x0,0x0,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x2000,0x80000000,0x80000000,0x0,0x0,0x800e4040,0x800e4040,0x800e4040,0x2000,0x0,0x0,0x810e4040,0x1000000,0x1000000,0x80000000,0x80084040,0x60040,0x80084040,0x8000,0x60040,0x380000,0x60040,0x8000,0x380000,0x0,0x0,0x0,0x0,0x2000,0x42,0x42,0x42,0x380100,0x380100,0x10000,0x8000,0x2000,0x42,0x380100,0x80020,0x2000,0x380100,0x400,0x0,0x8,0x408,0x10,0x2,0x80000000,0x0,0x0,0x1,0x400,0x200000,0x400,0x200000,0x0,0x1,0x1,0x400000,0x400000,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x6,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
