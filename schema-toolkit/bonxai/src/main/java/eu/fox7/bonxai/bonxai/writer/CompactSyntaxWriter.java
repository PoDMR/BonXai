...
import eu.fox7.bonxai.bonxai.BonxaiAttributeGroup;
...
import eu.fox7.bonxai.common.GroupReference;
...
//TODO:        traverseDataTypes(declaration.getDataTypeList(), visitor);
    ...
    protected void writeAnyAttribute(AnyAttribute anyAttribute) throws IOException {
    	...
    	writer.append(anyAttribute.getNamespace());
    	writer.append("}");
    }
    ...
    protected void writeParticle(Particle particle) throws IOException {
        if (particle instanceof AllPattern) {
            ...
            writeElement((eu.fox7.bonxai.bonxai.Element) particle);
