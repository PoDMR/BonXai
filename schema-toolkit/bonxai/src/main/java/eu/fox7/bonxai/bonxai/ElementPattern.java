...
public class ElementPattern {
     ...
     */
    private eu.fox7.bonxai.common.Particle regexp;
     ...
     * @param regexp
     */
    public ElementPattern(eu.fox7.bonxai.common.Particle regexp) {
        this.regexp = regexp;
    }
     ...
     * (nillable in XSD).
     */
    public ElementPattern(eu.fox7.bonxai.common.Particle regexp, boolean missing) {
        this(regexp);
        this.missing = missing;
    }
     ...
     * @return
     */
    public eu.fox7.bonxai.common.Particle getRegexp() {
        return regexp;
    }
