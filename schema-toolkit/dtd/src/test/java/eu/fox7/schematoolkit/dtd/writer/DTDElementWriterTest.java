...
public class DTDElementWriterTest extends junit.framework.TestCase {
    ...
    public void testGetElementDeclarationString() throws Exception {
        ...
        Element element2 = new Element(elementName);
        element2.setParticle(new AnyPattern(ProcessContentsInstruction.Strict, Namespace.EMPTY_NAMESPACE));
        ...
        Element element3 = new Element(elementName);
