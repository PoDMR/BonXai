...
import eu.fox7.schematoolkit.xsd.parser.exceptions.attribute.InvalidQNameException;
import eu.fox7.schematoolkit.xsd.parser.exceptions.content.AnyAttributeIsNotLastException;
import eu.fox7.schematoolkit.xsd.parser.exceptions.content.AttributeIsNotLastInContentModelException;
...
import eu.fox7.schematoolkit.xsd.parser.exceptions.inheritance.EmptyInheritanceBaseException;
import eu.fox7.schematoolkit.xsd.parser.exceptions.inheritance.RestrictionMultipleParticleException;
import eu.fox7.schematoolkit.xsd.parser.exceptions.inheritance.RestrictionWrongChildException;
...
public class RestrictionProcessorTest extends junit.framework.TestCase {
    ...
    public void testValidCaseSimpleType() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simpletype_valid.xsd"));
    ...
    public void testValidCaseSimpleContent() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simplecontent_valid.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testValidCaseComplexContent() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_valid.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_attr_group.xsd"));
    ...
    public void testIllegalObjectReturnedException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_illegal_object.xsd"));
    ...
    public void testRestrictionMultipleParticleExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_multi_group.xsd"));
    ...
    public void testRestrictionWrongChildExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simpletype_wrong_child_group.xsd"));
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithAll() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_attr_all.xsd"));
        } catch (AttributeIsNotLastInContentModelException error) {
            return;
        }
    ...
    public void testRestrictionMultipleParticleExceptionWithAll() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_multi_all.xsd"));
        } catch (RestrictionMultipleParticleException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithAll() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simpletype_wrong_child_all.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithChoice() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_attr_choice.xsd"));
        } catch (AttributeIsNotLastInContentModelException error) {
            return;
        }
    ...
    public void testRestrictionMultipleParticleExceptionWithChoice() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_multi_choice.xsd"));
        } catch (RestrictionMultipleParticleException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithChoice() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simpletype_wrong_child_choice.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testAttributeIsNotLastInContentModelExceptionWithSequence() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_attr_sequence.xsd"));
        } catch (AttributeIsNotLastInContentModelException error) {
            return;
        }
    ...
    public void testRestrictionMultipleParticleExceptionWithSequence() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_multi_sequence.xsd"));
        } catch (RestrictionMultipleParticleException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithSequence() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simpletype_wrong_child_sequence.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttributeAndComplexContentRestriction() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_anyattribute_attr_pos.xsd"));
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttributeAndSimpleContentRestriction() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simplecontent_anyattribute_attr_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithAttribute() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simpletype_wrong_child_attribute.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttributeGroupAndComplexContentRestriction() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_anyattribute_attrgroup_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
        fail("AnyAttribute is in the wrong position under a ComplexContentRestriction.");
    ...
    public void testAnyAttributeIsNotLastExceptionWithAttributeGroupAndSimpleContentRestriction() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simplecontent_anyattribute_attrgroup_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
        fail("AnyAttribute is in the wrong position under a SimpleContentRestriction.");
    ...
    public void testRestrictionWrongChildExceptionWithAttributeGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simpletype_wrong_child_attributegroup.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testAnyAttributeIsNotLastExceptionWithAnyAttributeAndComplexContentRestriction() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_anyattribute_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
        fail("AnyAttribute is in the wrong position under a ComplexContentRestriction.");
    ...
    public void testAnyAttributeIsNotLastExceptionWithAnyAttributeAndSimpleContentRestriction() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simplecontent_anyattribute_pos.xsd"));
        } catch (AnyAttributeIsNotLastException error) {
            return;
        }
        fail("AnyAttribute is in the wrong position under a SimpleContentRestriction.");
    ...
    public void testRestrictionWrongChildExceptionWithAnyAttribute() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_simpletype_wrong_child.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithSimpleType() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_simpletype.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithMinExclusive() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_minexclusive.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithMaxExclusive() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_maxexclusive.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithMinInclusive() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_mininclusive.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithMaxInclusive() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_maxinclusive.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithTotalDigits() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_totaldigits.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithFractionDigits() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_fractiondigits.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithLength() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_length.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithMinLength() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_minlength.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithMaxLength() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_maxlength.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithEnumeration() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_enumeration.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithWhiteSpace() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_whitespace.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testRestrictionWrongChildExceptionWithPattern() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_complexcontent_wrong_child_pattern.xsd"));
        } catch (RestrictionWrongChildException error) {
            return;
        }
    ...
    public void testEmptyInheritanceBaseException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_empty_inheritance_base.xsd"));
    ...
    public void testInvalidQNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_invalid_qname.xsd"));
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_empty_id.xsd"));
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_multi_annot.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/restrictionTests/restriction_wrong_content.xsd"));
