...
import eu.fox7.schematoolkit.xsd.parser.exceptions.attribute.ExclusiveAttributesException;
import eu.fox7.schematoolkit.xsd.parser.exceptions.attribute.InvalidNCNameException;
...
public class AttributeGroupProcessorTest extends junit.framework.TestCase {
    ...
    public void testValidCaseWithAttributeGroupAndAttributeGroupRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/attributeGroupTests/attributegroup_valid.xsd"));
    ...
    public void testInvalidQNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/attributeGroupTests/attributegroup_invalid_qname.xsd"));
    ...
    public void testExclusiveAttributesException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/attributeGroupTests/attributegroup_exclusive_attributes.xsd"));
    ...
    public void testEmptyIdExceptionWithAttributeGroupRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/attributeGroupTests/attributegroup_empty_id_2.xsd"));
    ...
    public void testInvalidNCNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/attributeGroupTests/attributegroup_invalid_ncname.xsd"));
    ...
    public void testEmptyIdExceptionWithAttributeGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/attributeGroupTests/attributegroup_empty_id.xsd"));
        } catch (EmptyIdException error) {
            return;
        }
        fail("ID is empty, but it was not detected.");
    ...
    public void testAnyAttributeIsNotLastException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/attributeGroupTests/attributegroup_anyattribute.xsd"));
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/attributeGroupTests/attributegroup_multi_annot.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/attributeGroupTests/attributegroup_wrong_content.xsd"));
