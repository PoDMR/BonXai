...
import eu.fox7.schematoolkit.xsd.tools.InterleaveHandler;
...
public class InterleaveHandlerTest extends junit.framework.TestCase {
    ...
    public void testInterleaveGroup() throws Exception {
        ...
        String uri = "/tests/eu/fox7/bonxai/xsd/tools/interleaveHandlerTests/interleaveGroup_root.xsd";
...
////        // Check no local elements with other name
    ...
    public void testNewIdentifier() throws Exception {
        ...
        String uri = "/tests/eu/fox7/bonxai/xsd/tools/interleaveHandlerTests/interleaveNewIdentifier_root.xsd";
        uri = this.getClass().getResource(uri).getFile();
