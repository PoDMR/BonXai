...
import eu.fox7.schematoolkit.xsd.om.XSDSchema.BlockDefault;
import eu.fox7.schematoolkit.xsd.om.XSDSchema.FinalDefault;
...
public class SchemaProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCase() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_valid.xsd"));
    ...
    public void testInvalidAnyUriException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_invalid_anyUri.xsd"));
    ...
    public void testInvalidAnyUriExceptionWithTargetNamespace() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_invalid_anyUri_targetNamespace.xsd"));
        } catch (InvalidAnyUriException error) {
            return;
        }
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_empty_id.xsd"));
    ...
    public void testInvalidElementFormDefaultValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_invalid_elementFormDefault_value.xsd"));
    ...
    public void testInvalidAttributeFormDefaultValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_invalid_attributeFormDefault_value.xsd"));
    ...
    public void testInvalidFinalDefaultValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_invalid_finalDefault_value.xsd"));
    ...
    public void testInvalidBlockDefaultValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_invalid_blockDefault_value.xsd"));
    ...
    public void testInvalidForeignSchemaLocationExceptionWithInclude() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_invalid_foreignSchema_location_include.xsd"));
    ...
    public void testInvalidForeignSchemaLocationExceptionWithImport() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_invalid_foreignSchema_location_import.xsd"));
        } catch (InvalidForeignSchemaLocationException error) {
            return;
        }
    ...
    public void testInvalidForeignSchemaLocationExceptionWithRedefine() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_invalid_foreignSchema_location_redefine.xsd"));
        } catch (InvalidForeignSchemaLocationException error) {
            return;
        }
    ...
    public void testIllegalObjectReturnedExceptionWithAttribute() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_illegal_object_returned_attribute.xsd"));
    ...
    public void testIllegalObjectReturnedExceptionWithElement() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_illegal_object_returned_element.xsd"));
        } catch (IllegalObjectReturnedException error) {
            return;
        }
    ...
    public void testIllegalObjectReturnedExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_illegal_object_returned_group.xsd"));
        } catch (IllegalObjectReturnedException error) {
            return;
        }
    ...
    public void testIllegalObjectReturnedExceptionWithAttributeGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_illegal_object_returned_attributeGroup.xsd"));
        } catch (IllegalObjectReturnedException error) {
            return;
        }
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_unsupported_content.xsd"));
    ...
    public void testDuplicateElementException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_duplicate_element.xsd"));
    ...
    public void testDuplicateAttributeException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/schemaTests/schema_duplicate_attribute.xsd"));
