...
public class ElementProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCaseWithElement() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_valid_element.xsd"));
    ...
    public void testValidCaseWithElementRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_valid_elementRef.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testValidCaseWithElementAndCountingPattern() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_valid_element_countingPattern.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testValidCaseWithElementRefAndCountingPattern() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_valid_elementRef_countingPattern.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testEmptyIdExceptionWithElement() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_empty_id_element.xsd"));
    ...
    public void testInvalidNillableException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_nillable.xsd"));
    ...
    public void testInvalidAbstractException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_abstract.xsd"));
    ...
    public void testInvalidFormValueLocationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_form_location.xsd"));
    ...
    public void testInvalidFormValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_form.xsd"));
    ...
    public void testInvalidFinalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_final.xsd"));
    ...
    public void testInvalidBlockValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_block.xsd"));
    ...
    public void testExclusiveAttributesExceptionWithFixedAndDefault() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_attributes_fixed_default.xsd"));
    ...
    public void testCountingPatternMaxOccursIllegalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_maxOccurs_illegal_value.xsd"));
    ...
    public void testCountingPatternMinOccursIllegalValueExceptionWithUnbound() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_minOccurs_illegal_value_unbound.xsd"));
    ...
    public void testCountingPatternMinOccursIllegalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_minOccurs_illegal_value.xsd"));
        } catch (CountingPatternMinOccursIllegalValueException error) {
            return;
        }
    ...
    public void testCountingPatternMinOccursGreaterThanMaxOccursException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_minOccurs_greater_than_maxOccurs.xsd"));
    ...
    public void testNonGlobalSubstitutionGroupException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_non_global_substitutionGroup.xsd"));
    ...
    public void testExclusiveAttributesExceptionWithSubstitutionGroupAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_attributes_substitutionGroup_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testInvalidQNameExceptionWithSubstitutionGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_qName_substitutionGroup.xsd"));
    ...
    public void testMissingNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_missing_name.xsd"));
    ...
    public void testInvalidQNameExceptionWithType() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_qName_type.xsd"));
        } catch (InvalidQNameException error) {
            return;
        }
    ...
    public void testExclusiveAttributesExceptionWithNameAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_attributes_name_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testExclusiveAttributesExceptionWithTypeAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_attributes_type_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testExclusiveAttributesExceptionWitNillableAndRefh() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_attributes_nillable_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testExclusiveAttributesExceptionWithDefaultAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_attributes_default_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testExclusiveAttributesExceptionWithFixedAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_attributes_fixed_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testExclusiveAttributesExceptionWithFormAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_attributes_form_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testExclusiveAttributesExceptionWithBlockAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_attributes_block_ref.xsd"));
        } catch (ExclusiveAttributesException error) {
            return;
        }
    ...
    public void testInvalidQNameExceptionWithRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_qName_ref.xsd"));
        } catch (InvalidQNameException error) {
            return;
        }
    ...
    public void testMultipleTypesExceptionWithComplexType() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_multiple_types_complexType.xsd"));
    ...
    public void testMultipleTypesExceptionWithSimpleType() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_multiple_types_simpleType.xsd"));
        } catch (MultipleTypesException error) {
            return;
        }
    ...
    public void testExclusiveContentExceptionWithUniqueAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_content_unique_ref.xsd"));
    ...
    public void testExclusiveContentExceptionWithKeyAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_content_key_ref.xsd"));
        } catch (ExclusiveContentException error) {
            return;
        }
    ...
    public void testExclusiveContentExceptionWithKeyRefAndRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_exclusive_content_keyRef_ref.xsd"));
        } catch (ExclusiveContentException error) {
            return;
        }
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_multiple_annotation.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_unsupported_content.xsd"));
    ...
    public void testInvalidFinalLocationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/elementTests/element_invalid_final_location.xsd"));
