...
import eu.fox7.schematoolkit.xsd.parser.exceptions.inheritance.MissingSimpleContentInheritanceException;
import eu.fox7.schematoolkit.xsd.parser.exceptions.inheritance.SimpleContentMultipleInheritanceException;
...
public class SimpleContentProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCase() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/simpleContentTests/simplecontent_valid.xsd"));
    ...
    public void testEmptyIdException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/simpleContentTests/simplecontent_empty_id.xsd"));
    ...
    public void testMissingSimpleContentInheritanceException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/simpleContentTests/simplecontent_no_inherit.xsd"));
    ...
    public void testSimpleContentMultipleInheritanceExceptionWithExtension() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/simpleContentTests/simplecontent_multi_inherit_ext.xsd"));
    ...
    public void testSimpleContentMultipleInheritanceExceptionWithRestriction() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/simpleContentTests/simplecontent_multi_inherit_restr.xsd"));
        } catch (SimpleContentMultipleInheritanceException error) {
            return;
        }
        fail("There is more than one Inheritance given, but this was not detected.");
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/simpleContentTests/simplecontent_multi_annot.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/simpleContentTests/simplecontent_wrong_content.xsd"));
