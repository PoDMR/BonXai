...
public class GroupProcessorTest extends junit.framework.TestCase{
    ...
    public void testValidCaseWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_valid_group.xsd"));
    ...
    public void testValidCaseWithGroupRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_valid_groupRef.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
    ...
    public void testValidCaseWithCountingPattern() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_valid_countingPattern.xsd"));
        } catch (Exception error) {
            fail("Exception was thrown: " + error);
        }
        ComplexContentType complexContentType = (ComplexContentType)((ComplexType) schema.getTypeSymbolTable().getReference("{http://www.w3.org/2001/XMLSchema}root").getReference()).getContent();
    ...
    public void testInvalidQNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_invalid_qName.xsd"));
    ...
    public void testExclusiveAttributesException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_exclusive_attributes.xsd"));
    ...
    public void testEmptyIdExceptionWithGroupRef() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_empty_id_groupRef.xsd"));
    ...
    public void testCountingPatternMaxOccursIllegalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_maxOccurs_illegal_value.xsd"));
    ...
    public void testCountingPatternMinOccursIllegalValueExceptionWithUnbound() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_minOccurs_illegal_value_unbound.xsd"));
    ...
    public void testCountingPatternMinOccursIllegalValueException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_minOccurs_illegal_value.xsd"));
        } catch (CountingPatternMinOccursIllegalValueException error) {
            return;
        }
    ...
    public void testCountingPatternMinOccursGreaterThanMaxOccursException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_minOccurs_greater_than_maxOccurs.xsd"));
    ...
    public void testInvalidNCNameException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_invalid_nCName.xsd"));
    ...
    public void testEmptyIdExceptionWithGroup() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_empty_id_group.xsd"));
        } catch (EmptyIdException error) {
            return;
        }
    ...
    public void testGroupMultipleParticleContainerExceptionWithAll() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_multiple_particleContainer_all.xsd"));
    ...
    public void testGroupMultipleParticleContainerExceptionChoice() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_multiple_particleContainer_choice.xsd"));
        } catch (GroupMultipleParticleContainerException error) {
            return;
        }
    ...
    public void testGroupMultipleParticleContainerExceptionSequence() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_multiple_particleContainer_sequence.xsd"));
        } catch (GroupMultipleParticleContainerException error) {
            return;
        }
    ...
    public void testMultipleAnnotationException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_multiple_annotation.xsd"));
    ...
    public void testUnsupportedContentException() throws Exception {
        try {
            schema = schemaProcessor.processNode(Utilities.getSchemaNode("tests/eu/fox7/bonxai/xsd/parser/xsds/groupTests/group_unsupported_content.xsd"));
