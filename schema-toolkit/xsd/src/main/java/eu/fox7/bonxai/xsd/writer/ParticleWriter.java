...
public abstract class ParticleWriter {
    ...
    protected static void writeParticle(Node root, Particle particle, XSDSchema schema, Integer min, Integer max) {
        if (particle instanceof ElementRef) {
            ...
            writeElement(root, (eu.fox7.bonxai.xsd.Element) particle, schema, min, max);
     ...
     */
    protected static void writeElement(Node root, eu.fox7.bonxai.xsd.Element element, XSDSchema schema) {
     ...
     * @param max
     */
    protected static void writeElement(Node root, eu.fox7.bonxai.xsd.Element element, XSDSchema schema, Integer min, Integer max) {
