...
public class XSDWriter {
     ...
     * @param foundElements
     */
    protected void writeGroups(Node root, Collection<eu.fox7.bonxai.xsd.Group> groups) {
        for (Group g : groups) {
     ...
     * @param foundElements
     */
    protected void writeElements(Node root, Collection<eu.fox7.bonxai.xsd.Element> elements) {
